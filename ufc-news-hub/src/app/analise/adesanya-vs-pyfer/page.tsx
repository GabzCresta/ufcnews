    ...
    momento_atual: {
      fighter1: {
        ...
        full_fight_history: [
          ...
          { date: 'Fev 2023', opponent: 'Alex Pereira', result: 'W', method: 'KO R2', opponent_rank: 'Campeao', quality_score: 5, quality_label: 'Excelente', note: 'Nocaute de vinganca' },
          ...
          { date: 'Ago 2024', opponent: 'Dricus Du Plessis', result: 'L', method: 'Sub R4', opponent_rank: 'Campeao', quality_score: 5, quality_label: 'Excelente', note: 'Primeira sub' },
          { date: 'Fev 2025', opponent: 'Nassourdine Imavov', result: 'L', method: 'TKO R2', opponent_rank: '#7 MW', quality_score: 4, quality_label: 'Muito Bom', note: 'Nocauteado' },
        ],
        momentum_score: 3,
