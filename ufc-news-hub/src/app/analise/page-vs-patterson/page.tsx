...
const analisePT: FullSingleAnalise = {
  ...
  full_analysis: {
    ...
    previsao_final: {
      ...
      explanation: 'Essa luta se resume a uma pergunta: Page consegue manter em pe? Com apenas 42% de defesa de takedown e Patterson completando 3.23 takedowns por 15 minutos, a matematica nao favorece MVP. Patterson tem as ferramentas para fechar a distancia (envergadura similar), levar ao chao e submeter. A defesa de takedown de Page foi explorada por Garry na derrota no UFC 303, e Patterson e um grappler mais perigoso no chao. No entanto, a experiencia de Page (3-1 no UFC) e seu striking criativo sao fatores que nao podem ser ignorados. Se Page manter distancia por 15 minutos, pode frustrar Patterson.',
      x_factor: {
    ...
    creator_kit: {
      ...
      twitter: [
        ...
        { num: '2/5', text: 'MVP (24-3): 13 KOs, 3-1 no UFC, 10 titulos mundiais de kickboxing, maos baixas, angulos impossiveis. Mas 42% de defesa de takedown. QUARENTA E DOIS.' },
        { num: '3/5', text: 'Patterson (14-2-1): 7 submissoes na carreira, QUATRO vitorias consecutivas no R1. O cara fecha e finaliza. E agora vai enfrentar alguem com 42% de TDD.' },
        ...
        { num: '5/5', text: 'Previsao: Patterson por submissao nos dois primeiros rounds. A matematica nao mente: 42% TDD vs 3.23 TDs por 15 min. Mas MVP e MVP. 3-1 no UFC. Sempre imprevisivel.' },
      ],
      video: [
      ...
      headlines: [
        'Page vs Patterson: 42% de TDD Encontra o Predador de Primeiro Round',
