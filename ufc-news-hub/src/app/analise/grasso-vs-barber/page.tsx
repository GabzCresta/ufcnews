  ...
  full_analysis: {
    ...
    momento_atual: {
      fighter1: {
        ...
        full_fight_history: [
          { date: 'Mar 2023', opponent: 'Valentina Shevchenko', result: 'W', method: 'Sub R4', opponent_rank: 'Campeao', quality_score: 5, quality_label: 'Excelente', note: 'Ganhou titulo' },
          { date: 'Set 2023', opponent: 'Valentina Shevchenko', result: 'D', method: 'SD (empate)', opponent_rank: 'Ex-campeao', quality_score: 5, quality_label: 'Excelente', note: 'Reteve titulo' },
          { date: 'Set 2024', opponent: 'Valentina Shevchenko', result: 'L', method: 'UD', opponent_rank: 'Ex-campeao', quality_score: 5, quality_label: 'Excelente', note: 'Perdeu titulo' },
      ...
      fighter2: {
        ...
        full_fight_history: [
          ...
          { date: 'Fev 2025', opponent: 'Amanda Ribas', result: 'W', method: 'TKO R2', opponent_rank: '#9 FLW', quality_score: 3, quality_label: 'Bom', note: 'Finalizacao' },
