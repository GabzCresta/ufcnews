          ...
          <div className="text-center">
            ...
            <div className="mt-10 md:mt-16 flex justify-center gap-6 sm:gap-10 md:gap-20">
              {[
                ...
                { value: '1', label: t('hero_stat_3_label') },
              ].map((item, i) => (
            ...
            <div className="rounded-2xl bg-zinc-900/40 border border-[#E20814]/20 p-8 relative overflow-hidden">
              ...
              <div className="space-y-6 relative">
                {[
                  ...
                  { label: t('compare_octagon_2_label'), value: t('compare_octagon_2_value'), sub: t('compare_octagon_2_sub'), big: true },
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
          {[
            ...
            { icon: Shield, name: t('analise_sec_03'), num: '03' },
            { icon: Database, name: t('analise_sec_04'), num: '04' },
            { icon: Trophy, name: t('analise_sec_05'), num: '05' },
            { icon: Brain, name: t('analise_sec_06'), num: '06' },
            { icon: Sparkles, name: t('analise_sec_07'), num: '07' },
          ].map((item, i) => (
