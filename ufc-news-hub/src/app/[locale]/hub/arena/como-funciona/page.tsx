...
import { PONTUACAO_CONFIG, CONQUISTAS_DEFINICOES } from '@/types/arena';
import { NIVEL_TIERS } from '@/lib/arena/xp-shared';
              ...
              {NIVEL_TIERS.map((tier) => {
                ...
                return (
                  <div
                    ...
                    style={{ borderLeft: `3px solid ${meta.tom.borda}` }}
                  >
                    <Icon
                    ...
                    />
                    <p className="font-display uppercase tracking-wider text-sm text-white mt-2">
                      {meta.label}
                    </p>
                    <p className="text-xs text-dark-textMuted mt-1">
                      {tier.floor === 0 ? 'início' : `${tier.floor.toLocaleString('pt-BR')} XP`}
                    </p>
                  </div>
                );
              })}
