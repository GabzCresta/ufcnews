...
const analise: PrelimsAnalise = {
  id: 'kamaka-vs-hope-pos-weighins',
  evento_id: null,
  slug: 'kamaka-vs-hope-pos-weighins',
  titulo: 'Kamaka vs Hope (Pos Weigh-Ins): 5 Dias de Aviso e Retorno ao UFC',
  subtitulo: null,
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise as any, locale, 'kamaka-vs-hope');
