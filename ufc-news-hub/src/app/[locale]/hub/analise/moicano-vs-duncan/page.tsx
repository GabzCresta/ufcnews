    ...
    momento_atual: {
      fighter1: {
        ...
        full_fight_history: [
          ...
          { date: 'Jun 2017', opponent: 'Brian Ortega', result: 'L', method: 'Sub R3', opponent_rank: '#4 FW', quality_score: 4, quality_label: 'Muito Bom', note: 'Derrota para futuro desafiante ao titulo' },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise, locale, 'moicano-vs-duncan');
