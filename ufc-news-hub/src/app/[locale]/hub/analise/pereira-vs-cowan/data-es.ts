    ...
    comparacao_estatistica: {
      stats: [
        ...
        },
        {
          ...
          format: 'decimal',
          reverseWinner: true,
          note: 'Numeros proximos na absorcao. ninguna e particularmente porosa, pero Pereira absorve um pouco mais apesar de ter melhor defesa percentual.',
        },
        {
        ...
        },
        {
          ...
          maxVal: 4,
          format: 'decimal',
          note: 'Cowan busca o takedown com alguma frequencia e 36% de precisao. Pereira nunca tentou takedown no UFC, pero defende 100% das tentativas.',
        },
        {
        ...
        },
        {
          ...
          maxVal: 100,
          format: 'percent',
          note: 'Pereira com 100% de defesa de takedown, perfeita ate agora. Cowan com 80% tambien e solida. Ambas tem bom sprawl.',
        },
      ],
      tale_of_tape: [
        {
        ...
        recent_fights: [
          {
            ...
            note: 'Primeira derrota de su carrera por decisao dividida. Luta extremamente competitiva que poderia ter ido para qualquer lado.',
          },
        ],
      },
      fighter2: {
        ...
        recent_fights: [
          ...
          },
          {
            ...
            quality_score: 1,
            quality_label: 'Malo',
            note: 'Vitoria no DWCS que garantiu contrato com o UFC. Pelea cerrada que veio por decisao dividida.',
          },
        ],
      },
    },
    ...
    perfil_habilidades: {
      skills: [
        ...
        },
        {
          ...
          labelB: 'Bueno',
          advantage: 'fighter2',
          advantage_note: 'Cowan tem alguma ofensiva de takedown (1.63 por 15 min). Pereira nunca tentou. Se Cowan conseguir levar a luta al suelo, pode ter vantagem.',
        },
        {
          ...
          labelB: 'Bueno',
          advantage: 'fighter1',
          advantage_note: 'Pereira defende 100% dos takedowns no UFC (amostra pequena, pero perfeita). Cowan com 80% tambien e boa, pero nao e ela que precisa defender.',
        },
        {
