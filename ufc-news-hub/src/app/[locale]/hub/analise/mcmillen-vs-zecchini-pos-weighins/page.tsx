...
const analise: FullSingleAnalise = {
  id: 'mcmillen-vs-zecchini-pos-weighins',
  evento_id: null,
  slug: 'mcmillen-vs-zecchini-pos-weighins',
  titulo: 'McMillen vs Zecchini (Pos Weigh-Ins): -1000 Favorito Bateu Peso, Debut Aguardado',
  subtitulo: 'McMillen 145.5 lbs, Zecchini 145 lbs. Sem drama na balanca. O invicto de Montana entra como maior favorito do main card no debut UFC.',
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
  tactical_breakdown: {
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise, locale, 'mcmillen-vs-zecchini-pos-weighins');
