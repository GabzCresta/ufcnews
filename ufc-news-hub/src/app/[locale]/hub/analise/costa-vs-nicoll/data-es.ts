...
export const analise: PrelimsAnalise = {
  ...
  prelims_analysis: {
      ...
      stats: [
        {
          ...
          maxVal: 6,
          format: 'decimal',
          note: 'Costa tem volume moderado e consistente. Nicoll fica um pouco atras, pero a diferenca nao e absurda. Ambos preferem lutas de media distancia.',
        },
        {
        ...
        },
        {
          ...
          maxVal: 4,
          format: 'decimal',
          note: 'Nicoll busca mais o takedown, pero sua precisao e horrivel (14%). Costa raramente tenta, preferindo lutar De pie.',
        },
        {
          ...
          maxVal: 100,
          format: 'percent',
          note: 'Ambos sao pessimos em converter takedowns. ningun dos dois depende do wrestling como arma primaria de forma eficiente.',
        },
        {
      ...
      tale_of_tape: [
        {
          ...
          fighter1: '30 anos',
          fighter2: '30 anos',
          note: 'Mesma idade, ambos na maturidade de su carrera',
        },
        {
          label: 'Altura',
          fighter1: '1,63m (5\'4")',
      ...
      fighter1: {
        ...
        recent_fights: [
          ...
          },
          {
            ...
            quality_score: 1,
            quality_label: 'Malo',
            note: 'Nocaute devastador no segundo round. Costa mostrou o poder explosivo que o faz peligroso a qualquer momento.',
          },
          {
            date: 'Nov 2023',
          ...
          },
          {
            ...
            quality_score: 4,
            quality_label: 'Muy Bueno',
            note: 'Perdeu para Albazi, outro nome de elite do peso-mosca. Costa briga com os melhores pero nao consegue vencer o topo.',
          },
        ],
      },
      fighter2: {
    ...
    perfil_habilidades: {
      skills: [
        ...
        },
        {
          ...
          labelB: 'Regular',
          advantage: 'even',
          advantage_note: 'ningun dos dois e wrestler de elite. Costa defende 83% dos takedowns enquanto Nicoll converte apenas 14%. ningun dos dois deve buscar a queda como plano A.',
        },
        {
          ...
          labelB: 'Malo',
          advantage: 'fighter1',
          advantage_note: 'Costa tem 7 lutas no UFC contra nomes como Erceg e Albazi. Nicoll tem apenas 2 lutas no octogono, ambas derrotas. La diferencia de experiencia e enorme.',
        },
        {
      ...
      insight: 'Costa domina em praticamente todas as categorias relevantes. La diferencia de experiencia e nivel de oponentes e abismal. Nicoll tem defesa porosa e zero vitorias no UFC, enquanto Costa ja nocauteou gente boa e so perde para a elite da divisao. Esse confronto favorece claramente o brasileiro.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'Costa e uma maquina de nocaute com 64% de vitorias por KO/TKO, incluindo finalizacoes brutais com cotoveladas e socos limpos. Nicoll tem um perfil mais equilibrado pero suas 8 vitorias vieram em circuitos regionais menores. A capacidade de finalizacao de Costa no nivel UFC e comprovada, enquanto Nicoll ainda precisa provar que pode competir nesse patamar.',
    },
    ...
    previsao_final: {
      ...
      x_factor: {
        ...
        description: 'Nicoll foi finalizado por guilhotina no R1 e perdeu por decisao na outra luta. nunca foi testado de verdade na trocacao contra um nocauteador. Se ele tiver queixo de ferro, pode sobreviver, pero os numeros sugerem o contrario.',
      },
      upset_alert: {
