...
export const analise: PrelimsAnalise = {
  ...
  prelims_analysis: {
    ...
    comparacao_estatistica: {
      stats: [
        {
          ...
          maxVal: 7,
          format: 'decimal',
          note: 'Kamaka tem alto volumen com 4.96 SLpM, top tier para peso-leve. Hope nao tem stats do UFC ainda (estreia), entao nao ha comparacao direta.',
        },
        {
        ...
        },
        {
          ...
          format: 'decimal',
          reverseWinner: true,
          note: 'Kamaka absorve 5.29 strikes por minuto, numero preocupante. Mostra que ele troca pesado pero tambien leva muito. Sem dados de Hope para comparar.',
        },
        {
        ...
        },
        {
          ...
          maxVal: 4,
          format: 'decimal',
          note: 'Kamaka busca takedowns com 58% de precisao, numero solido. Hope como estreante nao tem dados, pero seu record regional sugere forte grappling.',
        },
        {
      ...
      tale_of_tape: [
        ...
        },
        {
          ...
          fighter1: '175cm (69")',
          fighter2: '173cm (68")',
          note: 'Envergaduras quase identicas, sem vantagem significativa para ningun lado',
        },
        {
          label: 'Stance',
          fighter1: 'Ortodoxa',
      ...
      fighter1: {
        ...
        recent_fights: [
          ...
          },
          {
            ...
            quality_score: 2,
            quality_label: 'Regular',
            note: 'Derrota apertada por decisao dividida. Kamaka derrubou Brown pero nao conseguiu manter o controle. Teve 1 knockdown no fight.',
          },
          {
            date: 'Nov 2020',
          ...
          },
          {
            ...
            quality_score: 2,
            quality_label: 'Regular',
            note: 'Victoria solida por decisao com volume impressionante (114 strikes significativos em 3 rounds). Mostrou seu melhor atributo: volume de strikes.',
          },
        ],
      },
      fighter2: {
        ...
        recent_fights: [
          {
            ...
            quality_score: 1,
            quality_label: 'Malo',
            note: 'Hope vem com record de 11-1 do circuito regional. Debut en UFC sem historico de lutas no octogono. Apelido "Huracan" sugere estilo agresivo.',
          },
        ],
      },
    },
    ...
    perfil_habilidades: {
      skills: [
        ...
        },
        {
          ...
          labelB: 'Malo',
          advantage: 'fighter1',
          advantage_note: 'Kamaka tem 5 lutas no UFC (1-3-1) com experiencia contra nomes como Pearce e Brown. Hope faz sua estreia absoluta no octogono. La diferencia de experiencia e o maior trunfo de Kamaka.',
        },
        {
          ...
          labelB: 'Muy Bueno',
          advantage: 'fighter2',
          advantage_note: 'Hope tem 11-1 com apenas 1 derrota en su carrera. Kamaka esta 1-3-1 nas ultimas 5, com quase 5 anos desde sua ultima vitoria no UFC. O momentum esta completamente do lado de Hope.',
        },
        {
          ...
          labelB: 'Bueno',
          advantage: 'even',
          advantage_note: 'Kamaka tem 58% de precisao em takedowns com 1.93 TDs por 15 min. Hope nao tem dados UFC pero 11-1 no regional sugere capacidade. Sem dados concretos para Hope, consideramos equilibrado.',
        },
        {
      ...
      insight: 'Esta e uma luta interessante entre o veterano conhecido (Kamaka) e o estreante misterioso (Hope). Kamaka tem volume e experiencia, pero nao vence no UFC desde agosto de 2020 e esta em clara fase descendente (1-3-1 recente). Hope com 11-1 e completamente desconhecido, o que pode ser vantagem ou desvantagem. O UFC geralmente contrata prospectos para bater veteranos em queda, e esse parece ser o caso aqui.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'Kamaka tem distribuicao equilibrada com 17 vitorias divididas entre KO, submissao e decisao. Hope tem perfil mais de finalizador com 81% das vitorias antes da decisao (5 KOs + 4 subs). O fato de Hope terminar lutas cedo no circuito regional sugere que ele pode ser peligroso se conseguir impor seu ritmo desde o primeiro round.',
    },
    ...
    previsao_final: {
      ...
      explanation: 'Kamaka nao vence no UFC desde agosto de 2020 e retorna apos quase 5 anos de inatividade no octogono. Mesmo com experiencia, o hawaiano esta em clara fase descendente (1-3-1 nas ultimas 5). Hope entra como uma incognita total com 11-1, pero o padrao do UFC e claro: estreantes sao frequentemente escalados contra veteranos em declinio para construir novos nomes. Hope tem 81% de finalizacoes antes da decisao (KO/TKO + Subs), sugerindo um estilo agresivo. Com a defesa de takedown de Kamaka em apenas 52% e absorcao alta de strikes (5.29/min), Hope tem caminhos claros para explorar. A confianca e apenas MEDIA porque Hope e completamente desconhecido no UFC.',
      x_factor: {
        title: 'Kamaka retorna depois de 5 anos',
        description: 'A ultima luta de Kamaka no UFC foi em julho de 2021. Quase 5 anos fora do octogono e uma eternidade. Ele lutou no circuito regional pero o nivel do UFC e outro. Ring rust pode ser devastadora.',
      },
      upset_alert: {
