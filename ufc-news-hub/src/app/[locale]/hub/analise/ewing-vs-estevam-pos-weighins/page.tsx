...
const analise: FullSingleAnalise = {
  id: 'ewing-vs-estevam-pos-weighins',
  evento_id: null,
  slug: 'ewing-vs-estevam-pos-weighins',
  titulo: 'Ewing vs Estevam (Pos Weigh-Ins): ESTEVAM MISSED WEIGHT, Disciplina em Questao',
  subtitulo: 'Estevam pesou 136.5 lbs, perdeu 20% da bolsa. Missed weight no flyweight, missed weight no bantamweight. Problema cronico? Ewing bateu 135.5 lbs tranquilo.',
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
  tactical_breakdown: {
  ...
  fight_prediction: {
    ...
    fighter2Scenarios: [],
    keyFactors: [
      { factor: 'Wrestling Ofensivo', edge: 'fighter2', impact: 8, description: 'Estevam media 6.01 TDs por 15 min com 54% dos strikes vindos do chao. O wrestling e o motor do jogo dele.' },
      { factor: 'Volume de Strikes', edge: 'fighter1', impact: 7, description: 'Ewing conecta 5.67 SLpM contra 2.10 de Estevam. Em pe, Ewing domina o volume completamente.' },
    ...
    xFactor: {
      ...
      description: 'Ewing defendeu 100% dos takedowns na unica luta UFC. Amostra pequena, mas se conseguir manter Estevam em pe, domina.',
    },
  },
  fighter1_info: {
    nome: 'Ethyn Ewing',
    ...
    ranking: 'Sem Ranking',
    ultimasLutas: [
      { result: 'W', opponent: 'Malcolm Wellmaker', method: 'Decisao Unanime', event: 'UFC 322' },
    ],
  },
  fighter2_info: {
    nome: 'Rafael Estevam',
    ...
    ranking: 'Sem Ranking',
    ultimasLutas: [
      { result: 'W', opponent: 'Felipe Bunes', method: 'Decisao Unanime', event: 'UFC Fight Night' },
      { result: 'W', opponent: 'Jesus Aguilar', method: 'Decisao Unanime', event: 'UFC Fight Night' },
      { result: 'W', opponent: 'Charles Johnson', method: 'Decisao Unanime', event: 'UFC Fight Night' },
    ],
  },
  ...
  full_analysis: {
    ...
    narrativa: {
      ...
      stakes: [
        ...
        { dimensao: 'Sequencia', fighter1: '1-0 no UFC', fighter2: '3-0 no UFC, invicto na carreira' },
      ...
      prognostico: {
        fighter1_vence: {
          ...
          subtitulo: 'Ewing mantem a luta em pe e domina com volume absurdo de strikes',
          consequencias: [
            ...
            { tag: 'ESTILO', texto: 'Mostra que volume de strikes em pe pode neutralizar wrestling dominante' },
        ...
        fighter2_vence: {
          ...
          consequencias: [
            ...
            { tag: 'EWING', texto: 'Mostra que o volume em pe nao e suficiente se voce nao consegue se manter la.' },
          ],
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: 'Nov 2025', opponent: 'Malcolm Wellmaker', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Debut UFC no UFC 322. Volume absurdo: 85 strikes significativos conectados. Controlou a luta inteira em pe. Defendeu 100% dos TDs (3 de 3).' },
        ],
        momentum_score: 7,
        momentum_label: 'Confiante',
        momentum_trend: 'ascending',
        momentum_note: 'Ewing fez um debut solido no UFC com vitoria convincente por decisao unanime. O volume de strikes impressionou. Faixa marrom de Paulson, wrestling de base, e agora pai de primeira viagem. A motivacao esta alta. Apenas 1 luta UFC e amostra pequena, mas o desempenho foi promissor.',
      },
      fighter2: {
        nome: 'Rafael Estevam',
        color: 'blue',
        recent_fights: [
          { date: 'Ago 2025', opponent: 'Felipe Bunes', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: '3a vitoria UFC. Controlou com wrestling e strikes no chao.' },
          { date: 'Fev 2025', opponent: 'Jesus Aguilar', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: '11 takedowns tentados. Dominou com controle posicional. 2a vitoria UFC.' },
          { date: 'Nov 2023', opponent: 'Charles Johnson', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Debut UFC. Controlou com grappling.' },
        ],
        momentum_score: 7,
        momentum_label: 'Consistente',
        momentum_trend: 'stable',
        momentum_note: 'Estevam e a definicao de consistencia: 14-0, 3 vitorias no UFC, todas por UD. Nunca perdeu. O wrestling e o motor que move tudo. Treina na Nova Uniao no Rio. A qualidade dos oponentes ainda nao e alta, mas o invicto fala por si. 54% dos strikes vem do chao, o que mostra o quanto ele domina posicionalmente.',
      },
    },
    ...
    comparacao_estatistica: {
      stats: [
        { label: 'Sig. Strikes por Minuto', valueA: 5.67, valueB: 2.10, maxVal: 7, format: 'decimal', note: 'Ewing tem QUASE 3x mais volume de strikes. Em pe, a diferenca e absurda.' },
        { label: 'Precisao de Strikes (%)', valueA: 52, valueB: 54, maxVal: 100, format: 'percent', note: 'Precisao parecida. Estevam e levemente mais preciso, mas com muito menos volume.' },
        { label: 'Strikes Absorvidos/Min', valueA: 5.13, valueB: 2.59, maxVal: 7, format: 'decimal', reverseWinner: true, note: 'Ewing absorve o dobro. O volume alto vem com o preco de tambem levar.' },
        { label: 'Defesa de Strikes (%)', valueA: 47, valueB: 47, maxVal: 100, format: 'percent', note: 'Defesa identica: ambos a 47%. Nenhum dos dois e elite defensivamente.' },
        ...
        { label: 'Precisao de Takedown (%)', valueA: 60, valueB: 38, maxVal: 100, format: 'percent', note: 'Ewing converte mais (60% vs 38%), mas tenta muito menos. Estevam e mais persistente.' },
        { label: 'Defesa de Takedown (%)', valueA: 100, valueB: 66, maxVal: 100, format: 'percent', note: 'Ewing defendeu 100% dos TDs (3/3) no debut. Amostra MINUSCULA mas promissora. Estevam a 66%.' },
        { label: 'Submissoes por 15 Min', valueA: 0.0, valueB: 0.3, maxVal: 2, format: 'decimal', note: 'Nenhum dos dois e uma grande ameaca de submissao. A luta provavelmente vai pros pontos.' },
      ],
      tale_of_tape: [
        { label: 'Idade', fighter1: '30 anos', fighter2: '29 anos', note: 'Praticamente a mesma idade' },
    ...
    perfil_habilidades: {
      skills: [
        { label: 'Striking em Pe', valueA: 72, valueB: 45, labelA: 'Bom', labelB: 'Medio', advantage: 'fighter1', advantage_note: 'Ewing e infinitamente mais ativo em pe: 5.67 vs 2.10 SLpM. O volume e avassalador. Estevam praticamente nao compete em pe, prefere derrubar.' },
        { label: 'Wrestling Ofensivo', valueA: 55, valueB: 78, labelA: 'Bom', labelB: 'Muito Bom', advantage: 'fighter2', advantage_note: 'Estevam media 6.01 TDs por 15 min. 11 TDs tentados contra Aguilar em 1 luta. O wrestling e obsessivo e persistente.' },
        { label: 'Controle no Chao', valueA: 50, valueB: 80, labelA: 'Medio', labelB: 'Muito Bom', advantage: 'fighter2', advantage_note: '54% dos strikes de Estevam sao do chao. Quando derruba, controla e acumula ground and pound. Ewing precisa se levantar rapido.' },
        { label: 'Defesa de Takedown', valueA: 65, valueB: 58, labelA: 'Bom', labelB: 'Bom', advantage: 'fighter1', advantage_note: 'Ewing defendeu 100% no debut (amostra pequena). Tem base de wrestling do high school. A questao e se aguenta a persistencia de Estevam por 3 rounds.' },
        { label: 'Cardio e Ritmo', valueA: 68, valueB: 70, labelA: 'Bom', labelB: 'Bom', advantage: 'even', advantage_note: 'Ambos mostraram bom cardio em lutas de 3 rounds. Estevam mantem a pressao de wrestling por 15 minutos. Ewing mantem volume de strikes alto.' },
        { label: 'Fight IQ', valueA: 55, valueB: 65, labelA: 'Bom', labelB: 'Bom', advantage: 'fighter2', advantage_note: 'Estevam sabe o que funciona e executa: derruba, controla, vence nos pontos. 14-0. Ewing ainda esta se descobrindo no UFC.' },
      ],
      insight: 'O classico striker vs wrestler. Ewing domina em pe com volume absurdo (5.67 SLpM). Estevam domina no chao com wrestling persistente (6.01 TDs/15min). A luta sera decidida pelo local onde acontece. Se ficar em pe, Ewing vence nos pontos. Se for pro chao, Estevam controla. A defesa de takedown de Ewing e a variavel chave.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'Ewing e mais finalizador fora do UFC: 67% KO, 22% sub. Mas no UFC, sua unica vitoria foi por decisao. Estevam e um decisioner nato: 50% das vitorias por decisao, e TODAS as 3 vitorias UFC por UD. A luta provavelmente vai pros juizes. A questao e quem controla mais minutos.',
    },
      ...
      zones: [
        {
          ...
          description: 'Estevam vai buscar o takedown cedo pra estabelecer controle. Se encaixar no R1, pode controlar 3+ minutos do round com ground and pound. Ewing precisa usar o jab e o footwork pra manter distancia e defender o primeiro TD.',
        },
        {
          rounds: 'R2',
          danger_level: 5,
        ...
        },
        {
          ...
          description: 'Se a luta esta 1-1 nos rounds, o R3 decide tudo. Estevam vai ser mais agressivo nos takedowns. Ewing vai aumentar o volume. Quem ganhar esse round provavelmente ganha a luta. Urgencia maxima.',
        },
      ],
    },
    ...
    intangiveis: {
      items: [
        ...
        { icon: 'Target', title: 'Volume de 5.67 SLpM', fighter: 'Ewing', risk_level: 'POSITIVO', risk_color: 'green', description: '85 strikes significativos no debut. Ewing nao para de lancar. Se ficar em pe, o volume e avassalador.' },
        ...
        { icon: 'Flame', title: '54% Strikes do Chao', fighter: 'Estevam', risk_level: 'RISCO PARA EWING', risk_color: 'yellow', description: 'Estevam aplica mais da metade dos strikes significativos do chao. Se Ewing for derrubado, vai levar ground and pound consistente. O dano se acumula.' },
      ],
    },
    ...
    caminhos_vitoria: {
      fighter1: {
        ...
        scenarios: [
          { name: 'Volume em Pe Domina', probability: 25, method: 'Decisao Unanime', description: 'Ewing defende os takedowns de Estevam com o wrestling de base, mantem a luta em pe e acumula um volume absurdo de strikes. 5.67 SLpM por 3 rounds = vitoria clara nos cartoes.' },
          ...
          { name: 'Decisao Apertada', probability: 7, method: 'Decisao Dividida', description: 'Luta disputada onde Ewing vence 2 rounds por volume em pe e Estevam vence 1 por controle no chao. Split decision pro volume.' },
        ],
      },
      fighter2: {
        nome: 'Estevam',
        ...
        scenarios: [
          { name: 'Controle Total por Wrestling', probability: 30, method: 'Decisao Unanime', description: 'Estevam encaixa takedowns em todos os rounds, controla por cima e aplica ground and pound. 54% dos strikes do chao acumulam pontos e dano. Controla 8+ minutos da luta total no chao.' },
          ...
          { name: 'Decisao Apertada Pra Controle', probability: 14, method: 'Decisao Dividida', description: 'Estevam vence 2 rounds por controle no chao. Ewing vence 1 round quando fica em pe. Os juizes premiam o controle posicional de Estevam.' },
        ],
      },
    },
    ...
    previsao_final: {
      ...
      explanation: 'Estevam e 14-0 e tem um sistema de wrestling refinado que funciona consistentemente. 6.01 TDs por 15 min e uma pressao enorme de wrestling. Ewing tem base de wrestling e defendeu 100% dos TDs no debut, mas a amostra e minima (3 TDs). Contra Estevam, que vai tentar 10+ TDs numa luta, a persistencia pode ser demais. Se Estevam levar pro chao, 54% dos strikes vem de la. Ewing precisa da melhor performance defensiva da carreira pra manter em pe. POREM: se Ewing conseguir, o volume de 5.67 SLpM contra os 2.10 de Estevam e uma diferenca colossal em pe. A luta e mais equilibrada do que parece.',
      x_factor: {
      ...
      upset_alert: {
        ...
        description: 'Se Ewing manter em pe, o volume de 5.67 SLpM pode machucar. Estevam absorve strikes e nao e conhecido pela durabilidade. Se Ewing conectar limpo por 2 rounds, o TKO e possivel.',
      },
      probabilities: {
      ...
      value_picks: {
        moneyline: { pick: 'Ewing (+130)', reasoning: 'Se voce acredita que Ewing defende os TDs, o volume em pe e avassalador. +130 paga bem pro risco. A base de wrestling pode ser o diferencial.' },
        ...
        over_under: { pick: 'Over 2.5 Rounds', rounds: 2.5, reasoning: 'Ambos tendenciam pra decisao. Estevam controla mas nao finaliza. Ewing absorve mas aguenta. Vai a distancia.' },
    ...
    o_que_observar: {
      points: [
        { num: 1, title: 'Os 3 Primeiros Takedowns de Estevam', icon: 'Target', description: 'Se Estevam encaixar 2 dos primeiros 3 takedowns, a luta vai pro estilo dele. Se Ewing defender todos, Estevam esta em serios problemas porque nao compete bem em pe.' },
        { num: 2, title: 'Volume de Ewing nos Primeiros 3 Min', icon: 'Activity', description: 'Observe se Ewing esta lancando com o volume habitual. Se ele estiver lancando 5+ strikes por minuto e Estevam nao esta derrubando, e dominio total em pe.' },
        { num: 3, title: 'Tempo de Controle no Chao', icon: 'Clock', description: 'Se Estevam esta acumulando 2+ minutos de controle por round no chao, esta vencendo. Se o tempo de controle e menos de 1 minuto, Ewing esta se levantando rapido.' },
        { num: 4, title: 'Ground and Pound de Estevam', icon: 'Crosshair', description: '54% dos strikes de Estevam vem do chao. Observe se ele esta sendo ativo por cima ou apenas segurando posicao. Strikes ativos do chao ganham rounds. Controle passivo pode nao ser suficiente.' },
    ...
    creator_kit: {
      ...
      video: [
        ...
        { time: '25-40s', title: 'Analise', text: 'O classico striker vs wrestler. Estevam: 6.01 TDs, 54% dos strikes do chao. Ewing: 5.67 SLpM, volume imenso. Se ficar em pe, Ewing. Se for pro chao, Estevam. A defesa de TD decide.' },
      ...
      tiktok: [
        { hook: '14-0. Esse cara NUNCA perdeu. E ele derruba TODO MUNDO.', body: 'Estevam. 6 takedowns por 15 minutos. 54% dos strikes vem do chao. 3 vitorias no UFC, TODAS por decisao unanime. Agora enfrenta Ewing, que conectou 85 strikes no debut e defendeu TODOS os takedowns. Striker vs wrestler. Classico. Quem controla, vence.', cta: 'Volume ou wrestling? Comenta!' },
      ],
      headlines: [
    ...
    radar_apostador: {
      ...
      armadilha: {
        ...
        descricao: 'Estevam tem apenas 1 finish nos ultimos 7 resultados (4 KOs e 3 subs na carreira, mas 7 decisoes). No UFC, ZERO finishes em 3 lutas. Ewing tem 1 luta UFC = 1 decisao. Apostar em finish de qualquer lado e ir contra a tendencia.',
      },
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise, locale, 'ewing-vs-estevam-pos-weighins');
