...
export const analise: FullSingleAnalise = {
  ...
  fight_prediction: {
    ...
    fighter2Scenarios: [],
    keyFactors: [
      { factor: 'Volume de Strikes', edge: 'fighter1', impact: 9, description: 'McMillen media 7.53 SLpM contra 2.34 de Zecchini. La diferencia es mais de 3x. De pie, nao tem comparacao.' },
  ...
  full_analysis: {
    ...
    narrativa: {
      ...
      stakes: [
        ...
        { dimensao: 'Risco', fighter1: 'Primeira derrota de su carrera no debut UFC', fighter2: '2a derrota seguida = provavelmente cortado' },
      ...
      prognostico: {
        fighter1_vence: {
          ...
          consequencias: [
            ...
            { tag: 'ZECCHINI', texto: '2 derrotas consecutivas no UFC. Provavelmente cortado.' },
          ],
        ...
        fighter2_vence: {
          ...
          consequencias: [
            ...
            { tag: 'MCMILLEN', texto: 'Primeira derrota. O hype diminui, pero nao e o fim do mundo.' },
          ],
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: 'Set 2025', opponent: 'David Mgoyan', result: 'W', method: 'Decisao Majoritaria', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Regular', note: 'DWCS. 113 strikes significativos conectados. Volume absurdo. Venceu por decisao majoritaria e ganhou o contrato UFC.' },
        ],
        momentum_score: 7,
        momentum_label: 'Confiante',
        momentum_trend: 'ascending',
        momentum_note: 'McMillen esta Invicto em 9-0 e vem do DWCS com uma performance de alto volumen. O tamanho pro peso-pena (1,83m, 74" envergadura) e uma vantagem rara. O debut UFC e o grande teste, pero o hype e justificado pelo volume e pelo Invicto.',
      },
      fighter2: {
        nome: 'Manolo Zecchini',
        color: 'blue',
        recent_fights: [
          { date: 'Set 2023', opponent: 'Morgan Charriere', result: 'L', method: 'KO/TKO R1 (Chutes)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Regular', note: 'Debut UFC em Paris. Nocauteado no R1 por Charriere com chutes. Performance ruim: 21% precisao, 0% TD Def.' },
        ],
        momentum_score: 3,
        momentum_label: 'En Recuperacion',
        momentum_trend: 'descending',
        momentum_note: 'Zecchini Viene de derrota brutal no debut UFC. KO no R1, stats desastrosas. Teve mais de 2 anos de intervalo entre o debut e essa luta. A pausa longa pode ser positiva (tempo pra melhorar) ou negativa (ring rust). Os numeros da unica luta UFC sao preocupantes: 21% de precisao, 6.75 SApM.',
      },
    },
    ...
    comparacao_estatistica: {
      stats: [
        { label: 'Golpes Sig. por Minuto', valueA: 7.53, valueB: 2.34, maxVal: 9, format: 'decimal', note: 'McMillen tem mais de 3x o volume de Zecchini. 7.53 SLpM e um dos numeros mais altos do card inteiro.' },
        { label: 'Precision de Golpes (%)', valueA: 51, valueB: 21, maxVal: 100, format: 'percent', note: 'McMillen conecta 51% dos strikes. Zecchini apenas 21% na unica luta UFC. A precisao de Zecchini e alarmantemente baixa.' },
        { label: 'Golpes Absorbidos/Min', valueA: 5.67, valueB: 6.75, maxVal: 8, format: 'decimal', reverseWinner: true, note: 'Ambos absorvem demais. McMillen 5.67 e Zecchini 6.75. Lutas de volume = mais dano absorvido.' },
        { label: 'Defensa de Golpes (%)', valueA: 55, valueB: 46, maxVal: 100, format: 'percent', note: 'McMillen defende levemente melhor, pero ningun e elite defensivamente.' },
        { label: 'Defensa de Takedown (%)', valueA: 83, valueB: 0, maxVal: 100, format: 'percent', note: 'McMillen defendeu 83% dos TDs. Zecchini defendeu 0% (0/2) no debut. Preocupante.' },
        { label: 'Takedowns por 15 Min', valueA: 0.0, valueB: 0.0, maxVal: 3, format: 'decimal', note: 'ningun dos dois busca takedowns. Ambos preferem lutar De pie. Luta provavelmente fica De pie.' },
      ],
      tale_of_tape: [
        { label: 'Edad', fighter1: '28 anos', fighter2: '29 anos', note: 'Praticamente a mesma idade' },
    ...
    perfil_habilidades: {
      skills: [
        { label: 'Striking en Pie', valueA: 72, valueB: 50, labelA: 'Bueno', labelB: 'Regular', advantage: 'fighter1', advantage_note: 'McMillen conecta 7.53 SLpM com 51% de precisao. Zecchini conecta 2.34 com 21%. La diferencia de pie e absurda. O volume e a precisao favorecem McMillen completamente.' },
        { label: 'Defesa', valueA: 55, valueB: 40, labelA: 'Bueno', labelB: 'Regular', advantage: 'fighter1', advantage_note: 'McMillen defende 55% dos strikes e 83% dos TDs. Zecchini defende 46% dos strikes e 0% dos TDs (amostra pequena). McMillen e mais seguro defensivamente.' },
        { label: 'Grappling', valueA: 50, valueB: 45, labelA: 'Regular', labelB: 'Regular', advantage: 'even', advantage_note: 'Nenhum busca takedowns. Zecchini e faixa azul de BJJ (ha 8 anos no mesmo nivel, segundo ele). McMillen tem wrestling de base. Nenhum se destaca no chao.' },
        { label: 'Cardio y Ritmo', valueA: 65, valueB: 55, labelA: 'Bueno', labelB: 'Bueno', advantage: 'fighter1', advantage_note: 'McMillen manteve 113 strikes em 3 rounds no DWCS. O cara tem gas pra alto volumen. Zecchini foi parado no R1, nao sabemos o cardio.' },
        { label: 'Tamanho e Alcance', valueA: 85, valueB: 40, labelA: 'Muy Bueno', labelB: 'Regular', advantage: 'fighter1', advantage_note: 'McMillen tem 10cm de altura e 6 polegadas de alcance a mais. No peso-pena, isso e uma vantagem ENORME. Zecchini vai ter que entrar dentro da guarda, o que e peligroso.' },
        { label: 'Experiencia e Variabilidade', valueA: 45, valueB: 55, labelA: 'Regular', labelB: 'Bueno', advantage: 'fighter2', advantage_note: 'Zecchini tem 15 lutas profissionais (11-4) e treina na Jackson Wink sob coaches de elite. McMillen tem 9 lutas contra oposicao regional. Zecchini viu mais variedade.' },
      ],
      insight: 'McMillen tem todas as vantagens fisicas: mais alto, mais alcance, mais volume, mais preciso. Zecchini tem mais experiencia e treina numa academia de elite (Jackson Wink). Pero os numeros sao crueis: McMillen conecta 7.53 SLpM com 51% de precisao. Zecchini conecta 2.34 com 21%. La diferencia de alcance (6 polegadas) torna ainda mais dificil pra Zecchini entrar. A nao ser que Zecchini encontre algo que ninguem encontrou em 9 lutas, McMillen deve dominar.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'McMillen e primariamente um finalizador por strikes: 67% por KO/TKO. Zecchini e mais equilibrado: 36% KO, 36% sub, 27% decisao. McMillen busca o finish. Zecchini pode se adaptar. No DWCS, McMillen venceu por decisao (unica de su carrera), mostrando que pode ir a distancia quando preciso.',
    },
      ...
      zones: [
        {
          ...
          description: 'McMillen vai usar o jab e o alcance pra manter distancia e conectar com volume. Zecchini precisa entrar na guarda pra ser efetivo, pero com 6 polegadas a menos de alcance, cada entrada e arriscada. Se McMillen machucar Zecchini cedo, pode buscar o finish rapido.',
        },
        {
          rounds: 'R2',
          danger_level: 6,
    ...
    intangiveis: {
      items: [
        ...
        { icon: 'AlertTriangle', title: '21% de Precisao', fighter: 'Zecchini', risk_level: 'RIESGO ALTO', risk_color: 'red', description: 'Na unica luta UFC, Zecchini conectou apenas 21% dos strikes. Contra alguem com 6 polegadas a mais de alcance, pode ser ainda pior.' },
        { icon: 'Shield', title: 'Karateka de Berco', fighter: 'Zecchini', risk_level: 'POSITIVO', risk_color: 'green', description: 'Zecchini comecou karate A los 4 anos. cinturon negro. O estilo unorthodox pode criar angulos que McMillen nao esta acostumado a ver.' },
        { icon: 'Clock', title: 'Layoff de 2+ Anos', fighter: 'Zecchini', risk_level: 'RIESGO MEDIO', risk_color: 'yellow', description: 'Zecchini nao luta desde setembro de 2023. Mais de 2 anos parado. Ring rust e uma preocupacao real.' },
      ],
    },
    ...
    caminhos_vitoria: {
      ...
      fighter2: {
        ...
        scenarios: [
          ...
          { name: 'Desgaste e Decisao', probability: 10, method: 'Decision Dividida', description: 'Zecchini sobrevive o storm inicial e encontra seu ritmo. Vence rounds apertados com golpes mais limpos e eficientes, apesar do menor volume.' },
        ],
      },
    },
    ...
    previsao_final: {
      ...
      explanation: 'Os numeros sao esmagadores a favor de McMillen: 7.53 vs 2.34 SLpM, 51% vs 21% precisao, 10cm mais alto, 6 polegadas de alcance a mais. Zecchini absorve 6.75 SApM e foi nocauteado no R1 no debut UFC. La diferencia de tamanho e volume e demais. McMillen deve usar o jab pra manter distancia e acumular dano com combinacoes ate o arbitro parar. sin embargo: Zecchini treina na Jackson Wink e tem experiencia de 15 lutas. Se o game plan de Albuquerque funcionar, Zecchini pode surpreender. Pero os numeros nao favorecem o italiano.',
      x_factor: {
    ...
    o_que_observar: {
      points: [
        ...
        { num: 3, title: 'Ring Rust de Zecchini', icon: 'Clock', description: 'Mais de 2 anos sem lutar. Observe se Zecchini parece lento, indeciso ou desconfortavel nos primeiros minutos. Ring rust pode ser fatal contra um opponent de alto volumen.' },
    ...
    creator_kit: {
      ...
      video: [
        ...
        { time: '10-25s', title: 'Zecchini', text: 'Manolo Zecchini saiu de Veneza A los 17 anos sozinho pra lutar no Brasil. Treina na Jackson Wink. cinturon negro de karate. Pero: nocauteado no debut UFC, 21% de precisao, 2+ anos parado.' },
    ...
    radar_apostador: {
      ...
      armadilha: {
        ...
        descricao: 'McMillen tem apenas 1 decisao em 9 vitorias (11%). E primariamente um finalizador. Se ele vencer, provavelmente e por finish, nao nos pontos. Apostar em McMillen por decisao paga mais pero vai contra o perfil.',
      },
