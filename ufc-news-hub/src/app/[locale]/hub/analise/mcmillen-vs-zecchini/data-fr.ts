...
export const analise: FullSingleAnalise = {
  ...
  subtitulo: 'O invaincu de Montana que nao para de atirar contra o italiano radicado nos EUA que busca reabilitacao apos derrota no debut UFC.',
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
  tactical_breakdown: {
  ...
  fight_prediction: {
    ...
    fighter2Scenarios: [],
    keyFactors: [
      { factor: 'Volume de Strikes', edge: 'fighter1', impact: 9, description: 'McMillen media 7.53 SLpM contra 2.34 de Zecchini. La difference est mais de 3x. Debout, nao tem comparacao.' },
      ...
      { factor: 'Defesa de Zecchini', edge: 'fighter1', impact: 8, description: 'Zecchini absorve 6.75 SLpM e defende seulement 46% dos strikes. No debut UFC, foi nocauteado por Charriere no R1 com chutes.' },
    ],
    xFactor: {
      title: 'A Vantagem de Tamanho de McMillen',
      description: '10cm mais alto e 6 polegadas de envergadura a mais. McMillen parece um meio-medio lutando no peso-pena. O tamanho pode ser dominant.',
    },
  },
  fighter1_info: {
    nome: 'Tommy McMillen',
  ...
  full_analysis: {
    hero: {
      ...
      tagline_sub: 'O invaincu de Montana com volume insano contra o italiano que precisa vencer pra sobreviver no UFC. Tamanho vs Coracao.',
      fighter1: {
        ...
        record: '9-0-0',
        ranking: 'Non Classe',
        info_extra: 'Great Falls, Montana | Phoenix, AZ | 28 ans',
      ...
      fighter2: {
        ...
        record: '11-4-0',
        ranking: 'Non Classe',
        info_extra: 'Veneza, Italia | Jackson Wink MMA | 29 ans',
        imagem_fullbody_url: null,
      },
    },
    ...
    narrativa: {
      ...
      stakes: [
        ...
        { dimensao: 'Sequencia', fighter1: '9-0 invaincu', fighter2: 'Vem de KO sofrido no debut' },
        ...
        { dimensao: 'Recompensa', fighter1: 'Se estabelecer como prospect do peso-pena', fighter2: 'Vitoria sobre invaincu = renovacao garantida' },
      ],
      prognostico: {
        fighter1_vence: {
          ...
          consequencias: [
            ...
            { tag: 'ZECCHINI', texto: '2 defaites consecutives no UFC. Provavelmente cortado.' },
          ],
          proxima_luta: 'McMillen vs prospect similar ou veterano do peso-pena',
        },
        fighter2_vence: {
          titulo: 'A REABILITACAO DO ANJO',
          subtitulo: 'Zecchini mostra que o debut foi acidente e derrota o invaincu',
          consequencias: [
            { tag: 'SOBREVIVENCIA', texto: 'Zecchini salva a vaga no UFC e prova que merece estar la' },
            { tag: 'UPSET', texto: 'Derrotar um invaincu de 9-0 no debut dele seria uma declaracao' },
            { tag: 'MCMILLEN', texto: 'Primeira derrota. O hype diminui, mais nao e o fim do mundo.' },
          ],
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: 'Set 2025', opponent: 'David Mgoyan', result: 'W', method: 'Decisao Majoritaria', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Moyen', note: 'DWCS. 113 strikes significativos conectados. Volume absurdo. Venceu por decisao majoritaria e ganhou o contrato UFC.' },
        ],
        momentum_score: 7,
        momentum_label: 'Confiante',
        momentum_trend: 'ascending',
        momentum_note: 'McMillen esta invaincu em 9-0 e vem do DWCS com uma performance de volume eleve. O tamanho pro peso-pena (1,83m, 74" envergadura) e uma vantagem rara. O debut UFC e o grande teste, mais o hype e justificado pelo volume e pelo invaincu.',
      },
      fighter2: {
        nome: 'Manolo Zecchini',
        color: 'blue',
        recent_fights: [
          { date: 'Set 2023', opponent: 'Morgan Charriere', result: 'L', method: 'KO/TKO R1 (Chutes)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Moyen', note: 'Debut UFC em Paris. Nocauteado no R1 por Charriere com chutes. Performance ruim: 21% precisao, 0% TD Def.' },
        ],
        momentum_score: 3,
        momentum_label: 'En Recuperation',
        momentum_trend: 'descending',
        momentum_note: 'Zecchini Vient de perdre brutal no debut UFC. KO no R1, stats desastrosas. Teve mais de 2 ans de intervalo entre o debut e essa luta. A pausa longa pode ser positiva (tempo pra melhorar) ou negativa (ring rust). Os numeros da unica luta UFC sao preocupantes: 21% de precisao, 6.75 SApM.',
      },
    },
    ...
    comparacao_estatistica: {
      stats: [
        { label: 'Frappes Sig. par Minute', valueA: 7.53, valueB: 2.34, maxVal: 9, format: 'decimal', note: 'McMillen tem mais de 3x o volume de Zecchini. 7.53 SLpM e um dos numeros mais altos do card inteiro.' },
        { label: 'Precision des Frappes (%)', valueA: 51, valueB: 21, maxVal: 100, format: 'percent', note: 'McMillen conecta 51% dos strikes. Zecchini seulement 21% na unica luta UFC. A precisao de Zecchini e alarmantemente baixa.' },
        { label: 'Frappes Absorbees/Min', valueA: 5.67, valueB: 6.75, maxVal: 8, format: 'decimal', reverseWinner: true, note: 'Les deux absorvem demais. McMillen 5.67 e Zecchini 6.75. Lutas de volume = mais dano absorvido.' },
        { label: 'Defense de Frappes (%)', valueA: 55, valueB: 46, maxVal: 100, format: 'percent', note: 'McMillen defende levemente melhor, mais nenhum e elite defensivamente.' },
        { label: 'Defense Takedown (%)', valueA: 83, valueB: 0, maxVal: 100, format: 'percent', note: 'McMillen defendeu 83% dos TDs. Zecchini defendeu 0% (0/2) no debut. Preocupante.' },
        { label: 'Takedowns par 15 Min', valueA: 0.0, valueB: 0.0, maxVal: 3, format: 'decimal', note: 'Nenhum dos dois busca takedowns. Les deux preferem lutar Debout. Luta provavelmente fica Debout.' },
      ],
      tale_of_tape: [
        { label: 'Age', fighter1: '28 anos', fighter2: '29 anos', note: 'Praticamente a mesma idade' },
        { label: 'Taille', fighter1: '1,83m (6\'0")', fighter2: '1,73m (5\'8")', note: 'McMillen 10cm MAIS ALTO. Enorme pra peso-pena.' },
        { label: 'Allonge', fighter1: '188cm (74")', fighter2: '173cm (68")', note: 'McMillen com 6 POLEGADAS de vantagem. Mismatch de alcance.' },
    ...
    perfil_habilidades: {
      skills: [
        { label: 'Striking Debout', valueA: 72, valueB: 50, labelA: 'Bon', labelB: 'Moyen', advantage: 'fighter1', advantage_note: 'McMillen conecta 7.53 SLpM com 51% de precisao. Zecchini conecta 2.34 com 21%. A diferenca em pe e absurda. O volume e a precisao favorecem McMillen completamente.' },
        { label: 'Defesa', valueA: 55, valueB: 40, labelA: 'Bon', labelB: 'Moyen', advantage: 'fighter1', advantage_note: 'McMillen defende 55% dos strikes e 83% dos TDs. Zecchini defende 46% dos strikes e 0% dos TDs (amostra pequena). McMillen e mais seguro defensivamente.' },
        { label: 'Grappling', valueA: 50, valueB: 45, labelA: 'Moyen', labelB: 'Moyen', advantage: 'even', advantage_note: 'Nenhum busca takedowns. Zecchini e faixa azul de BJJ (ha 8 anos no mesmo nivel, segundo ele). McMillen tem wrestling de base. Nenhum se destaca no chao.' },
        { label: 'Cardio et Rythme', valueA: 65, valueB: 55, labelA: 'Bon', labelB: 'Bon', advantage: 'fighter1', advantage_note: 'McMillen manteve 113 strikes em 3 rounds no DWCS. O cara tem gas pra volume alto. Zecchini foi parado no R1, nao sabemos o cardio.' },
        { label: 'Tamanho e Alcance', valueA: 85, valueB: 40, labelA: 'Tres Bon', labelB: 'Moyen', advantage: 'fighter1', advantage_note: 'McMillen tem 10cm de altura e 6 polegadas de alcance a mais. No peso-pena, isso e uma vantagem ENORME. Zecchini vai ter que entrar dentro da guarda, o que e dangereux.' },
        { label: 'Experiencia e Variabilidade', valueA: 45, valueB: 55, labelA: 'Moyen', labelB: 'Bon', advantage: 'fighter2', advantage_note: 'Zecchini tem 15 lutas profissionais (11-4) e treina na Jackson Wink sob coaches de elite. McMillen tem 9 lutas contra oposicao regional. Zecchini viu mais variedade.' },
      ],
      insight: 'McMillen tem todas as vantagens fisicas: mais alto, mais alcance, mais volume, mais preciso. Zecchini tem mais experiencia e treina numa academia de elite (Jackson Wink). Mais os numeros sao crueis: McMillen conecta 7.53 SLpM com 51% de precisao. Zecchini conecta 2.34 com 21%. A diferenca de alcance (6 polegadas) torna ainda mais dificil pra Zecchini entrar. A nao ser que Zecchini encontre algo que ninguem encontrou em 9 lutas, McMillen deve dominar.',
    },
      ...
      zones: [
        {
          ...
          description: 'McMillen vai usar o jab e o alcance pra manter distancia e conectar com volume. Zecchini precisa entrar na guarda pra ser efetivo, mais com 6 polegadas a menos de alcance, cada entrada e arriscada. Se McMillen machucar Zecchini cedo, pode buscar o finish rapido.',
        },
        {
          rounds: 'R2',
          danger_level: 6,
    ...
    intangiveis: {
      items: [
        { icon: 'Zap', title: '6 Polegadas de Alcance', fighter: 'McMillen', risk_level: 'POSITIF', risk_color: 'green', description: 'McMillen tem 74" vs 68" de Zecchini. 6 polegadas de alcance no peso-pena e uma vantagem brutal. Zecchini vai ter que entrar dentro da guarda pra qualquer coisa.' },
        { icon: 'Target', title: '7.53 SLpM', fighter: 'McMillen', risk_level: 'POSITIF', risk_color: 'green', description: 'O maior volume de strikes significativos por minuto do card principal. McMillen e uma metralhadora.' },
        { icon: 'Brain', title: 'Jackson Wink', fighter: 'Zecchini', risk_level: 'POSITIF', risk_color: 'green', description: 'Zecchini treina na Jackson Wink sob Winkeljohn e Jackson. Os coaches podem ter um game plan pra lidar com o tamanho. A academia e de primeiro nivel.' },
        { icon: 'AlertTriangle', title: '21% de Precisao', fighter: 'Zecchini', risk_level: 'RISQUE ELEVE', risk_color: 'red', description: 'Na unica luta UFC, Zecchini conectou apenas 21% dos strikes. Contra alguem com 6 polegadas a mais de alcance, pode ser ainda pior.' },
        { icon: 'Shield', title: 'Karateka de Berco', fighter: 'Zecchini', risk_level: 'POSITIF', risk_color: 'green', description: 'Zecchini comecou karate A 4 ans. ceinture noire. O estilo unorthodox pode criar angulos que McMillen nao esta acostumado a ver.' },
        { icon: 'Clock', title: 'Layoff de 2+ Anos', fighter: 'Zecchini', risk_level: 'RISQUE MOYEN', risk_color: 'yellow', description: 'Zecchini nao luta desde setembro de 2023. Mais de 2 ans parado. Ring rust e uma preocupacao real.' },
      ],
    },
    ...
    caminhos_vitoria: {
      fighter1: {
        ...
        scenarios: [
          ...
          { name: 'Decisao por Dominio', probability: 22, method: 'Decision Unanime', description: 'McMillen controla a distancia por 3 rounds inteiros. O alcance de 6 polegadas e o volume tornam impossivel pra Zecchini competir. Vitoria nos pontos sem drama.' },
      ...
      fighter2: {
        ...
        scenarios: [
          { name: 'Karate Unorthodox', probability: 12, method: 'KO R1-R2', description: 'Zecchini usa angulos de karate e movimentos unorthodox pra entrar dentro da guarda de McMillen. Flying knee ou chute rodado surpreende o invaincu. Jackson Wink preparou um game plan especial.' },
          ...
          { name: 'Desgaste e Decisao', probability: 10, method: 'Decision Partagee', description: 'Zecchini sobrevive o storm inicial e encontra seu ritmo. Vence rounds apertados com golpes mais limpos e eficientes, apesar do menor volume.' },
        ],
      },
    },
    ...
    o_que_observar: {
      points: [
        ...
        { num: 3, title: 'Ring Rust de Zecchini', icon: 'Clock', description: 'Mais de 2 ans sem lutar. Observe se Zecchini parece lento, indeciso ou desconfortavel nos primeiros minutos. Ring rust pode ser fatal contra um opponent de volume eleve.' },
    ...
    creator_kit: {
      ...
      video: [
        ...
        { time: '10-25s', title: 'Zecchini', text: 'Manolo Zecchini saiu de Veneza A 17 ans sozinho pra lutar no Brasil. Treina na Jackson Wink. ceinture noire de karate. Mais: nocauteado no debut UFC, 21% de precisao, 2+ anos parado.' },
      ...
      tiktok: [
        { hook: '1 METRO E 83 no peso PENA. Esse cara e ENORME.', body: 'McMillen. Montana. 9-0 invaincu. 7.53 strikes por minuto, o MAIOR volume do card. 74 polegadas de envergadura. Contra Zecchini, italiano de Veneza que tem 68 polegadas. 6 POLEGADAS a menos. E Zecchini foi nocauteado no debut UFC. Precisao de 21%. Os numeros sao crueis.', cta: 'Zecchini tem ALGUMA chance? Comenta!' },
      ],
      headlines: [
        'McMillen vs Zecchini: 6 Polegadas de Alcance e o Maior Volume do Card',
        'Tommygun de Montana: O invaincu de 1,83m Que Parece Um Meio-Medio no Peso-Pena',
    ...
    radar_apostador: {
      ...
      armadilha: {
        ...
        descricao: 'McMillen tem seulement 1 decisao em 9 vitorias (11%). E primariamente um finalizador. Se ele vencer, provavelmente e por finish, nao nos pontos. Apostar em McMillen por decisao paga mais mais vai contra o perfil.',
      },
