...
export const analise: FullSingleAnalise = {
  ...
  fight_prediction: {
    ...
    fighter2Scenarios: [],
    keyFactors: [
      { factor: 'Volume de Strikes', edge: 'fighter1', impact: 9, description: 'Delano conecta 9.73 strikes significativos por minuto contra 2.27 de Ruchala. La diferencia de volume e absurda.' },
      { factor: 'Ameaca de Takedown', edge: 'fighter2', impact: 6, description: 'Ruchala tem 2.00 TDs por 15 min e BJJ faixa marrom. en el suelo, e peligroso.' },
  ...
  full_analysis: {
    hero: {
      ...
      fighter1: {
        ...
        record: '16-3-0',
        ranking: 'Sin Ranking',
        info_extra: 'Recife, Brasil | Rio de Janeiro | 29 anos',
      ...
      fighter2: {
        ...
        record: '11-2-0',
        ranking: 'Sin Ranking',
        info_extra: 'Nowy Sacz, Polonia | 27 anos',
        imagem_fullbody_url: null,
      },
    },
    ...
    narrativa: {
      ...
      `,
      stakes: [
        { dimensao: 'Ranking', fighter1: 'Sin Ranking', fighter2: 'Sin Ranking' },
      ...
      prognostico: {
        fighter1_vence: {
          ...
          subtitulo: 'Delano mantem De pie, sufoca com volume e confirma que e uma ameaca real no peso-pena',
          consequencias: [
            { tag: 'MOMENTUM', texto: '2 victorias consecutivas no UFC. O brasileiro de Recife comeca a se consolidar no roster.' },
        ...
        fighter2_vence: {
          ...
          proxima_luta: 'Ruchala vs outro peso-pena en ascenso',
        },
      },
    },
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: '2025', opponent: 'Manuel Exposito', result: 'W', method: 'Decision Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Regular', note: 'Debut UFC. Volume absurdo de 9.73 SLpM. Dominou nos pes por 3 rounds inteiros.' },
        ],
        momentum_score: 7,
        momentum_label: 'En Llamas',
        momentum_trend: 'ascending',
        momentum_note: 'Delano chegou ao UFC com um debut impressionante. 16-3 en su carrera, campeao do Shooto Brasil, e mostrou um volume de strikes que chama atencao. O numero de 9.73 SLpM e excepcional, mesmo considerando que foi apenas 1 luta UFC. O brasileiro esta confiante, Viene de victoria, e traz o estilo agresivo que funciona bem no Apex.',
      },
      fighter2: {
        nome: 'Robert Ruchala',
        color: 'blue',
        recent_fights: [
          { date: '2025', opponent: 'William Gomis', result: 'L', method: 'Decision Unanime', opponent_rank: 'N/R', quality_score: 3, quality_label: 'Bueno', note: 'Debut UFC, derrota. Nao conseguiu impor o grappling contra Gomis. Superado nos pes.' },
        ],
        momentum_score: 4,
        momentum_label: 'En Recuperacion',
        momentum_trend: 'descending',
        momentum_note: 'Ruchala perdeu o debut no UFC contra William Gomis. Nao e uma derrota desonrosa: Gomis e talentoso. Pero o polones nao conseguiu executar o plano de jogo de levar al suelo. As estatisticas do debut sao preocupantes: 2.27 SLpM e 35% de precisao nos pes. Se nao conseguir impor o grappling novamente, vai ter o mesmo problema.',
      },
    },
    ...
    nivel_competicao: {
      ...
      oponentes_em_comum_note: 'Nao ha oponentes em comum. Ambos sao novatos no UFC com apenas 1 luta cada. Delano venceu o debut, Ruchala perdeu. O que temos pra comparar sao os estilos: Delano e um striker de volumen absurdo, Ruchala e um grappler que precisa levar al suelo. E o classico striker vs grappler no nivel mais basico da divisao.',
    },
    ...
    comparacao_estatistica: {
      stats: [
        { label: 'Golpes Sig. por Minuto', valueA: 9.73, valueB: 2.27, maxVal: 12, format: 'decimal', note: 'La diferencia es ABSURDA. Delano lanca mais de 4x o volume de strikes de Ruchala. Se a luta ficar De pie, e massacre.' },
        { label: 'Precision de Golpes (%)', valueA: 65, valueB: 35, maxVal: 100, format: 'percent', note: 'Delano acerta quase o dobro. 65% e elite, 35% e preocupante. Ruchala nao e striker.' },
        { label: 'Golpes Absorbidos/Min', valueA: 2.53, valueB: 3.27, maxVal: 6, format: 'decimal', reverseWinner: true, note: 'Delano absorve menos e defende mais. O brasileiro e mais eficiente em todas as metricas de striking.' },
        { label: 'Defensa de Golpes (%)', valueA: 72, valueB: 57, maxVal: 100, format: 'percent', note: 'Delano defende 72% dos strikes. Ruchala defende 57%. Vantagem clara pro brasileiro na trocacao.' },
        { label: 'Takedowns por 15 Min', valueA: 0.00, valueB: 2.00, maxVal: 5, format: 'decimal', note: 'Delano nao tentou ningun takedown no debut. Ruchala tenta TDs ativamente. El suelo es el territorio do polones.' },
        { label: 'Precision de Takedown (%)', valueA: 0, valueB: 33, maxVal: 100, format: 'percent', note: 'Ruchala converteu 33% dos TDs no debut. Precisa melhorar pra impor o grappling contra Delano.' },
        { label: 'Defensa de Takedown (%)', valueA: 60, valueB: 0, maxVal: 100, format: 'percent', note: 'Delano defendeu 60% dos TDs. Ruchala teve 0% de defesa: dado preocupante, embora com amostra pequena.' },
      ],
      tale_of_tape: [
        { label: 'Edad', fighter1: '29 anos', fighter2: '27 anos', note: 'Ambos jovens, Ruchala 2 anos mais novo' },
        { label: 'Altura', fighter1: '1,73m (5\'8")', fighter2: '1,73m (5\'8")', note: 'Mesma altura' },
        { label: 'Envergadura', fighter1: '179cm (70.5")', fighter2: '183cm (72")', note: 'Ruchala com vantagem de 1.5 polegadas de envergadura' },
        { label: 'Stance', fighter1: 'Ortodoxo', fighter2: 'Switch', note: 'Ruchala alterna stances. Pode criar angulos diferentes.' },
    ...
    perfil_habilidades: {
      skills: [
        { label: 'Striking en Pie', valueA: 82, valueB: 40, labelA: 'Muy Bueno', labelB: 'Regular', advantage: 'fighter1', advantage_note: 'Delano e cinturon negro de Muay Thai com volume de quase 10 strikes por minuto e 65% de precisao. Ruchala acertou apenas 35% no debut e media 2.27 SLpM. La diferencia de pie e enorme.' },
        { label: 'Wrestling Ofensivo', valueA: 30, valueB: 60, labelA: 'Malo', labelB: 'Bueno', advantage: 'fighter2', advantage_note: 'Delano nao tentou um unico takedown no debut. Ruchala tenta TDs ativamente (2.00/15min) e e faixa marrom de BJJ. O chao e o caminho de Ruchala.' },
        { label: 'Jiu-Jitsu / Sumisiones', valueA: 45, valueB: 70, labelA: 'Regular', labelB: 'Bueno', advantage: 'fighter2', advantage_note: 'Ruchala e faixa marrom de BJJ e campeao polones. Delano e faixa roxa. Se a luta for al suelo, Ruchala tem vantagem tecnica.' },
        { label: 'Defensa y Durabilidad', valueA: 72, valueB: 48, labelA: 'Bueno', labelB: 'Regular', advantage: 'fighter1', advantage_note: 'Delano defende 72% dos strikes e 60% dos TDs. Ruchala defende 57% dos strikes e teve 0% de defesa de TD no debut. Delano e mais sólido defensivamente.' },
        { label: 'Cardio y Tanque', valueA: 75, valueB: 55, labelA: 'Muy Bueno', labelB: 'Bueno', advantage: 'fighter1', advantage_note: 'Manter 9.73 SLpM por 3 rounds exige cardio excepcional. Delano mostrou que aguenta. Ruchala precisa provar que consegue sustentar pressao de grappling por 15 minutos.' },
        { label: 'Experiencia de Elite', valueA: 40, valueB: 35, labelA: 'Regular', labelB: 'Regular', advantage: 'even', advantage_note: 'Ambos sao novatos no UFC com 1 luta cada. Delano tem mais vitorias na carreira (16-3 vs 11-2), mas nenhum enfrentou competicao de alto nivel no octogono.' },
      ],
      insight: 'Essa e uma luta de estilos completamente opostos. Delano domina De pie com volume brutal, precisao e defesa. Ruchala precisa levar al suelo onde o jiu-jitsu faixa marrom pode fazer a diferenca. A pergunta central: Ruchala consegue encaixar takedowns contra Delano? Se nao, vai ser uma noite longa absorvendo strikes. Se sim, pode surpreender com o grappling.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'Delano e majoritariamente um finalizador por KO/TKO (50% das vitorias), condizente com o Muay Thai e o volumen absurdo. Ruchala tambien tem finish rate alta (81%), com mix de KO (45%) e submissao (36%). Ambos buscam o finish, pero de maneiras diferentes: Delano com strikes, Ruchala com grappling. A ironia e que Ruchala tambien tem nocautes, pero nos pes contra Delano, e suicidio tentar trocar.',
    },
      ...
      zones: [
        {
          ...
          description: 'Se a luta comecar De pie, Delano vai sufoca com volume. 9.73 SLpM com 65% de precisao e devastador. Ruchala precisa encaixar o takedown temprano, porque cada segundo De pie e territorio do brasileiro. O R1 pode definir a luta inteira: se Delano estabelecer o ritmo, Ruchala vai ter que perseguir takedowns desesperados.',
        },
        {
          rounds: 'R2',
          danger_level: 5,
          ...
          description: 'Se Ruchala sobreviver o R1 e fizer ajustes no grappling, o R2 pode ser onde ele encontra o ritmo. Historicamente, grapplers que perdem o R1 De pie comecam a ser mais agressivos nas entradas no R2. Pero se Delano mantiver a distancia e o volume, vai dominar novamente.',
        },
        {
          rounds: 'R3',
          danger_level: 6,
    ...
    intangiveis: {
      items: [
        { icon: 'Zap', title: 'Volume de 9.73 SLpM', fighter: 'Delano', risk_level: 'ENORME POSITIVO', risk_color: 'green', description: 'O numero fala por si. Quase 10 strikes significativos por minuto e extraordinario. Mesmo que parte disso se deva a amostra pequena (1 luta UFC), a tendencia e real: Delano e um metralhador.' },
        { icon: 'Shield', title: 'BJJ Faixa Marrom', fighter: 'Ruchala', risk_level: 'POSITIVO', risk_color: 'green', description: 'Ruchala e campeao polones de BJJ e faixa marrom. Se conseguir levar al suelo, tem ferramentas reais pra buscar finalizacoes ou controle de posicao. O problema e chegar la.' },
        { icon: 'AlertTriangle', title: 'Derrota no Debut UFC', fighter: 'Ruchala', risk_level: 'RIESGO MEDIO', risk_color: 'yellow', description: 'Ruchala perdeu pra Gomis no debut. A pressao de uma possivel 2a derrota seguida e real. No UFC, 0-2 geralmente significa corte. O fator psicologico pesa.' },
        { icon: 'Target', title: 'Defesa de TD de 60%', fighter: 'Delano', risk_level: 'RIESGO MEDIO', risk_color: 'yellow', description: 'Delano defendeu 60% dos TDs no debut. Nao e ruim, pero tambien nao e impermeavel. Se Ruchala for mais agresivo nas entradas que Gomis, pode encontrar aberturas.' },
        { icon: 'Activity', title: 'Switch Stance', fighter: 'Ruchala', risk_level: 'NEUTRO', risk_color: 'neutral', description: 'Ruchala alterna stances (switch). Pode criar angulos diferentes pra entradas de takedown e confundir o timing de Delano nos pes. E uma ferramenta tatica que pode ajudar.' },
        { icon: 'Brain', title: 'Experiencia em Organizacoes Europeias', fighter: 'Ruchala', risk_level: 'NEUTRO', risk_color: 'neutral', description: 'Ruchala passou pelo KSW e pela cena polaca de MMA, que e competitiva. Treinou com Dustin Poirier. A exposicao a diferentes estilos pode ajudar, pero no debut nao foi o suficiente.' },
      ],
    },
    ...
    caminhos_vitoria: {
      fighter1: {
        ...
        scenarios: [
          { name: 'Dominio De pie', probability: 32, method: 'Decision Unanime', description: 'Delano mantem a luta De pie, defende os takedowns e sufoca Ruchala com volume. 9.73 SLpM por 3 rounds, controlando a distancia com o Muay Thai. Ruchala nao consegue impor o grappling e perde nos pontos de forma clara.' },
      ...
      fighter2: {
        ...
        scenarios: [
          { name: 'Ground Control', probability: 18, method: 'Decision Unanime', description: 'Ruchala encaixa takedowns consistentes (pelo menos 2 por round), mantem controle en el suelo e acumula tempo de controle. Mesmo sem finalizar, domina nos pontos com posicao superior e ground and pound.' },
          { name: 'Sumision', probability: 12, method: 'Submissao R1-R2', description: 'Ruchala encaixa um takedown temprano e transita pra posicao dominante. Com a faixa marrom de BJJ, encontra um arm triangle, RNC ou guilhotina. Delano, faixa roxa, pode nao ter defesa suficiente se for pego em posicao ruim.' },
          { name: 'TKO no Ground and Pound', probability: 5, method: 'TKO R2-R3', description: 'Ruchala consegue o takedown, passa a guarda e martela com ground and pound. Delano nao consegue se levantar e o arbitro para. Cenario menos provavel pero possivel.' },
        ],
      },
    },
    ...
    previsao_final: {
      ...
      explanation: 'Os numeros contam uma historia bem clara aqui. Delano media 9.73 strikes significativos por minuto com 65% de precisao e 72% de defesa. Ruchala media 2.27 SLpM com 35% de precisao e 57% de defesa. De pie, nao tem jogo. A unica chance de Ruchala e impor o grappling, pero no debut contra Gomis, ja nao conseguiu fazer isso. Delano defende 60% dos TDs, e o volumen absurdo dele pune cada tentativa de entrada que falha. O cenario mais provavel e Delano mantendo a distancia, sufocando com volume, e vencendo nos pontos de forma relativamente clara. O risco de upset existe se Ruchala vier com um grappling muito mais agresivo que no debut, pero as evidencias apontam pro brasileiro.',
      x_factor: {
        title: 'O Volume de 9.73 SLpM e Sustentavel?',
        description: 'O numero absurdo de Delano vem de apenas 1 luta UFC. Se ele repetir algo proximo disso, e praticamente impossivel perder De pie. Pero se o volume cair significativamente na 2a luta (talvez Ruchala traga mais pressao de grappling), a vantagem diminui.',
      },
      upset_alert: {
        title: 'Ruchala com Grappling agresivo',
        description: 'Se Ruchala aprendeu com o debut e vier muito mais agresivo nas entradas de takedown, pode surpreender. O polones e faixa marrom de BJJ e campeonato polones de grappling. Se conseguir levar al suelo nos primeiros minutos, o jogo muda completamente. A defesa de TD de 60% de Delano nao e impermeavel.',
      },
      probabilities: {
      ...
      value_picks: {
        moneyline: { pick: 'Delano ML', reasoning: 'Os numeros sao claros demais. Volume de 9.73 SLpM contra 2.27. Precisao de 65% contra 35%. Se a luta ficar De pie, e dominio total. E Ruchala nao provou que consegue impor o grappling no nivel UFC.' },
        ...
        over_under: { pick: 'Over 2.5 Rounds', rounds: 2.5, reasoning: 'Delano venceu por decisao no debut. Mesmo com alto volumen, tende a acumular dano em vez de buscar o KO. Ruchala e faixa marrom de BJJ e provavelmente duro de finalizar. A luta deve ir ate o fim.' },
        best_value: 'Delano por Decisao e a aposta mais segura. Volume dominante, pero sem poder de KO explosivo demonstrado no UFC. Ruchala sobrevive pero perde nos pontos.',
      },
    },
    ...
    creator_kit: {
      ...
      video: [
        ...
        { time: '10-25s', title: 'Ruchala', text: 'Robert Faker Ruchala. Faixa marrom de BJJ. Campeao polones de grappling. Treinou com Dustin Poirier. Pero no debut UFC, perdeu pra William Gomis sem conseguir impor o takedown. Agora e 0-1 e precisa vencer.' },
        { time: '25-40s', title: 'O Conflito', text: 'Striker vs Grappler. O classico do MMA. Delano com Muay Thai cinturon negro e volumen absurdo. Ruchala com BJJ faixa marrom e wrestling. Se fica De pie, Delano esmaga. Se vai al suelo, Ruchala pode surpreender. Quem impoe o estilo?' },
        { time: '40-55s', title: 'A Analise', text: 'Os numeros contam tudo: 9.73 contra 2.27 em volume. 65% contra 35% em precisao. De pie, sem comparacao. Ruchala precisa encaixar takedowns. Delano defende 60%. Cada tentativa que falha e mais dano absorvido. A matematica nao favorece o polones.' },
        { time: '55-70s', title: 'Pick e CTA', text: 'Pick: Delano por decisao unanime. O volume e a precisao dominam. Pero fique de olho nos primeiros 2 minutos. Se Ruchala derrubar cedo, tudo muda. Comenta quem voce acha que ganha.' },
      ],
      tiktok: [
        { hook: '9.73 strikes significativos por MINUTO. Esse cara e uma metralhadora humana.', body: 'Jose Delano. Brasileiro de Recife. cinturon negro de Muay Thai. No debut UFC, destruiu com volume. Agora enfrenta Ruchala, faixa marrom de BJJ da Polonia que perdeu o debut. Striker vs Grappler. Se ficar De pie, Delano esmaga. Se for al suelo, Ruchala tem chance. Pero Delano defende 60% dos TDs e pune cada entrada. Desafio pro polones.', cta: 'Striker ou grappler? Quem voce aposta? Comenta!' },
      ],
      headlines: [
        ...
        'Ruchala Precisa Vencer Pra Sobreviver no UFC. O Problema: Enfrenta um Muay Thai cinturon negro.',
    ...
    radar_apostador: {
      ...
      edges: [
        ...
        { icon: 'Target', titulo: 'Precisao Superior de Delano', stat_headline: '65% DE PRECISAO CONTRA 35%. DELANO ACERTA QUASE O DOBRO.', contexto: 'Alem do volume, Delano e preciso. 65% e numero de elite no peso-pena. Ruchala com 35% mostra que o striking nao e a area dele.', implicacao_aposta: 'Reforça Delano como favorito De pie. Prop de mais strikes acertados tem valor claro.', edge_level: 'forte', fighter_side: 'fighter1' },
        { icon: 'Shield', titulo: 'BJJ de Ruchala', stat_headline: 'FAIXA MARROM DE BJJ. CAMPEAO POLONES. GRAPPLER DE CARREIRA.', contexto: 'Se Ruchala levar al suelo, tem as ferramentas pra buscar finalizacao ou controle. O problema e chegar la contra um cara que defende 60% dos TDs e pune com volume.', implicacao_aposta: 'Se voce acredita que Ruchala encaixa TDs, prop de submissao pode ter valor. Alto risco.', edge_level: 'leve', fighter_side: 'fighter2' },
      ...
      armadilha: {
        ...
        descricao: 'Ruchala so vence essa luta se impor o grappling. Se ele esta vencendo por decisao, significa que controlou o chao o suficiente pra dominar nos pontos. Pero o historico dele (2 decisoes em 11 vitorias) e os numeros do debut dizem que e improvavel. Se Ruchala nao conseguir finalizar en el suelo, provavelmente esta perdendo De pie.',
      },
