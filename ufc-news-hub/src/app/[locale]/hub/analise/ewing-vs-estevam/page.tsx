...
const analise: FullSingleAnalise = {
  ...
  subtitulo: 'O striker californiano com volume absurdo contra o wrestler invicto de Macapa que nao sabe perder. 9-2 vs 14-0.',
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
  tactical_breakdown: {
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise, locale, 'ewing-vs-estevam');
