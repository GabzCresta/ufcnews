...
const analise: FullSingleAnalise = {
  ...
  subtitulo: 'O prospect russo-tchetcheno de 25 anos que finaliza em 30 segundos contra o finalizador brasileiro com 2 derrotas seguidas. Velocidade absurda vs experiencia.',
  lutador1_id: null,
  lutador2_id: null,
  artigo_conteudo: '',
  tactical_breakdown: {
  ...
  full_analysis: {
    ...
    narrativa: {
      ...
      stakes: [
        ...
        { dimensao: 'Risco', fighter1: 'Primeira derrota da carreira contra veterano perigoso', fighter2: '3a derrota seguida = provavelmente cortado do UFC' },
      ...
      prognostico: {
        fighter1_vence: {
          ...
          consequencias: [
            ...
            { tag: 'RANKING', texto: 'Ainda nao entra no ranking, mas o UFC vai comecar a dar oponentes maiores' },
        ...
        fighter2_vence: {
          ...
          subtitulo: 'Ribeiro usa a experiencia pra frustrar o invicto e consegue a vitoria mais importante da carreira UFC',
          consequencias: [
    ...
    momento_atual: {
      ...
      fighter2: {
        ...
        momentum_note: 'Ribeiro esta em espiral descendente. 2 KOs sofridos seguidos no R1. O queixo esta em duvida. A defesa de takedown de 18% e alarmante contra qualquer wrestler. Aos 29 anos, ainda tem tempo pra se recuperar, mas precisa desesperadamente de uma vitoria aqui. Uma 3a derrota seguida pode significar o corte do UFC.',
      },
    },
    ...
    comparacao_estatistica: {
      stats: [
        { label: 'Sig. Strikes por Minuto', valueA: 20.95, valueB: 3.06, maxVal: 22, format: 'decimal', note: 'O numero de Yakhyaev e ABSURDO, mas inflado por lutas muito curtas (33 segundos). Nao e um volume sustentavel. Ribeiro tem numero mais realista.' },
        { label: 'Precisao de Strikes (%)', valueA: 78, valueB: 42, maxVal: 100, format: 'percent', note: 'Yakhyaev conectou 78% dos strikes na unica luta UFC. Novamente, amostra pequena, mas impressionante.' },
        { label: 'Strikes Absorvidos/Min', valueA: 0.95, valueB: 4.00, maxVal: 6, format: 'decimal', reverseWinner: true, note: 'Yakhyaev quase nao leva strikes porque acaba a luta antes. Ribeiro absorve demais.' },
        { label: 'Defesa de Strikes (%)', valueA: 75, valueB: 53, maxVal: 100, format: 'percent', note: 'Yakhyaev defende melhor, mas o contexto (lutas curtissimas) distorce.' },
        { label: 'Takedowns por 15 Min', valueA: 14.29, valueB: 0.90, maxVal: 15, format: 'decimal', note: 'Yakhyaev e ABSURDAMENTE agressivo nos takedowns. 14.29 por 15 min. Ribeiro quase nao busca TDs.' },
        { label: 'Defesa de Takedown (%)', valueA: 100, valueB: 18, maxVal: 100, format: 'percent', note: 'A estatistica que define a luta. Yakhyaev defende 100% e Ribeiro APENAS 18%. Isso e uma disparidade colossal.' },
        { label: 'Submissoes por 15 Min', valueA: 14.3, valueB: 0.6, maxVal: 15, format: 'decimal', note: 'Yakhyaev tenta subs a todo momento (inflado pela luta curta). Ribeiro tem subs na carreira mas nao busca tanto no UFC.' },
      ],
      tale_of_tape: [
    ...
    perfil_habilidades: {
      skills: [
        { label: 'Striking em Pe', valueA: 60, valueB: 55, labelA: 'Bom', labelB: 'Bom', advantage: 'even', advantage_note: 'Ambos tem poder de finalizacao em pe, mas nenhum e um striker tecnico de elite. Yakhyaev mostrou socos pesados no DWCS. Ribeiro tem 9 KOs na carreira.' },
        { label: 'Wrestling Ofensivo', valueA: 90, valueB: 35, labelA: 'Excelente', labelB: 'Ruim', advantage: 'fighter1', advantage_note: 'Mestre de Esportes em Sambo de Combate. 14.29 TDs por 15 min. 100% de precisao de TD (amostra pequena). Contra Ribeiro que defende 18% dos TDs, e mismatch puro.' },
        { label: 'Jiu-Jitsu / Submissoes', valueA: 80, valueB: 65, labelA: 'Muito Bom', labelB: 'Bom', advantage: 'fighter1', advantage_note: 'Yakhyaev submeteu Cerqueira com RNC em 33 segundos. Ribeiro tem 7 subs na carreira (4 guilhotinas), mas no chao contra um sambista, esta em desvantagem.' },
        { label: 'Defesa e Durabilidade', valueA: 65, valueB: 40, labelA: 'Bom', labelB: 'Medio', advantage: 'fighter1', advantage_note: 'Ribeiro foi nocauteado 4 vezes na carreira, incluindo 2 seguidas recentemente. O queixo e uma preocupacao seria. Yakhyaev nunca foi derrubado ou finalizado.' },
        { label: 'Cardio e Resistencia', valueA: 50, valueB: 55, labelA: 'Medio', labelB: 'Bom', advantage: 'fighter2', advantage_note: 'NINGUEM sabe o cardio de Yakhyaev. Nenhuma luta passou do R1. Ribeiro ja foi a decisao varias vezes. Se a luta durar, Ribeiro pode ter vantagem.' },
        { label: 'Experiencia UFC', valueA: 30, valueB: 55, labelA: 'Ruim', labelB: 'Bom', advantage: 'fighter2', advantage_note: 'Ribeiro tem 7 lutas no UFC. Yakhyaev tem 1 (de 33 segundos). A experiencia no octogono e incomparavelmente diferente.' },
      ],
      insight: 'Mismatch no wrestling e o resumo dessa luta. Yakhyaev e um wrestler/sambista de elite que derruba todo mundo. Ribeiro defende 18% dos takedowns. Se Yakhyaev conseguir o clinch (e ele vai conseguir), o takedown e praticamente garantido. No chao, o sambo de combate e a ameaca de RNC sao demais pro Ribeiro. A unica chance de Ribeiro e pegar Yakhyaev em pe com algo grande nos primeiros segundos, antes do clinch.',
    },
    ...
    distribuicao_vitorias: {
      ...
      insight: 'Ambos sao finalizadores natos. Yakhyaev: 88% de finalizacao (50% KO + 38% sub). Ribeiro: 94% de finalizacao (53% KO + 41% sub). Ambos tem apenas 1 decisao na carreira. Essa luta provavelmente NAO vai pros cartoes. Alguem vai ser finalizado. A questao e quem.',
    },
      ...
      zones: [
        {
          ...
          description: 'Yakhyaev vai buscar o takedown nos primeiros 30 segundos, como fez em TODAS as lutas recentes. Com Ribeiro defendendo apenas 18% dos TDs, o takedown e quase certo. Se levar pro chao, a submissao pode vir em menos de 1 minuto. Ribeiro precisa sobreviver os primeiros 2 minutos a todo custo.',
        },
        {
          rounds: 'R1 (2-5min)',
          danger_level: 6,
          ...
          description: 'Se Ribeiro defender o primeiro takedown (improvavel mas possivel), a luta pode se equilibrar. Em pe, ambos tem poder de nocaute. Ribeiro tem vantagem de alcance (81" vs 78"). Os 9 KOs de Ribeiro nao sao ficticao.',
        },
        {
          rounds: 'R2-R3',
          danger_level: 4,
    ...
    intangiveis: {
      items: [
        ...
        { icon: 'AlertTriangle', title: '2 KOs Sofridos Seguidos', fighter: 'Ribeiro', risk_level: 'RISCO ALTO', risk_color: 'red', description: 'Ribeiro foi nocauteado no R1 em 2 lutas seguidas (Murzakanov e Sy). O queixo esta em questao. Apos sofrer KOs consecutivos, a durabilidade diminui.' },
        ...
        { icon: 'Activity', title: 'Cardio Desconhecido', fighter: 'Yakhyaev', risk_level: 'RISCO MEDIO', risk_color: 'yellow', description: 'Yakhyaev nunca passou do R1. Se Ribeiro sobreviver os primeiros minutos, ninguem sabe como Yakhyaev lida com fadiga. E a maior incognita.' },
    ...
    caminhos_vitoria: {
      fighter1: {
        ...
        scenarios: [
          ...
          { name: 'Dominio por 3 Rounds', probability: 15, method: 'Decisao Unanime', description: 'Improvavel mas possivel: Yakhyaev derruba repetidamente, controla no chao, mas nao consegue a finalizacao. Vence cada round por controle total e acumulo de ground and pound.' },
        ],
      },
      fighter2: {
        nome: 'Ribeiro',
        ...
        scenarios: [
          ...
          { name: 'Cardio Vence Hype', probability: 6, method: 'TKO R2-R3', description: 'Ribeiro sobrevive o R1, Yakhyaev nunca esteve no R2 e comeca a cansar. Ribeiro usa a experiencia e o cardio pra acumular dano e parar a luta. Improvavel, mas possivel.' },
        ],
      },
    },
    ...
    previsao_final: {
      ...
      upset_alert: {
        ...
        description: 'Ribeiro tem 4 guilhotinas na carreira. Se Yakhyaev for agressivo demais na entrada do takedown e abaixar a cabeca, pode ser pego. E o cenario de upset mais realista.',
      },
      probabilities: {
    ...
    creator_kit: {
      ...
      video: [
        ...
        { time: '10-25s', title: 'Ribeiro', text: 'Brendson Ribeiro, o Gorila da Amazonia. 9 KOs, 7 submissoes, 11 finalizacoes no R1. O cara e perigoso. MAS: 2 nocautes sofridos seguidos e a pior defesa de TD do card. 3a derrota = fim no UFC.' },
        { time: '25-40s', title: 'Analise', text: 'Yakhyaev: Mestre de Esportes em Sambo, 14.29 TDs por 15 min, 100% precisao de TD. Ribeiro: 18% TD Def. Os numeros nao mentem. A unica chance de Ribeiro e pegar uma guilhotina ou conectar em pe antes do clinch.' },
      ...
      tiktok: [
        { hook: '33 SEGUNDOS. Esse e o tempo TOTAL que esse cara ficou no UFC. E ele submeteu o oponente.', body: 'Yakhyaev. 25 anos. 8-0. Mestre de Sambo. E agora enfrenta Ribeiro, que defende 18% dos takedowns e foi nocauteado 2 vezes seguidas. 18 POR CENTO. Isso e praticamente deitar no chao e pedir. Under 1.5 rounds e a aposta mais facil do card.', cta: 'Voce acha que Ribeiro sobrevive o R1? Comenta!' },
      ],
      headlines: [
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const data = await loadAnalysisData(analise, locale, 'yakhyaev-vs-ribeiro');
