...
export const analise: FullSingleAnalise = {
  ...
  full_analysis: {
    ...
    previsao_final: {
      ...
      explanation:
        "The pick is Joshua Van by decision. The real edge sits in three genuinely independent dimensions: stats (Van 8.84 SLpM highest in UFC history + 56.8% accuracy + 81% elite TDD vs Taira's 45% TDD), direct common opponent (Van beat Royval by UD with 419 combined sig strikes; Taira lost to the same Royval with a 124-42 differential), and momentum (newly-crowned champion peaking vs Taira coming off his only career loss). Why conviction caps at 7 and not 8: first, \"stats\" and \"common opponent\" are partially correlated — both reflect Van's UFC 317 performance — that is 1.5 dimensions, not 2. Second, Taira has rare-tier traits the volume thesis ignores: 18-1, NEVER knocked out, NEVER submitted in 19 pro fights — chin and sub defense at a level that makes close-card scenarios for the underdog more live than the spread suggests. Third, Van's 81% TDD has never been tested against a primary grappler at Taira's level (Royval is grappler-pressure, not grappler-first). Taira has a viable path (32%): force entries via the clinch with the 3-inch reach edge, land a takedown in R1, transition to back control + body triangle the way he finished Moreno and Perez, or simply ride the elite chin for 25 minutes and capitalize in close rounds.",
      x_factor: {
      ...
      upset_alert: {
        title: 'Taira Locks the Body Triangle or Drags It Out',
        description: "Taira's path is a repeat of what he did against Moreno in R2: takedown → back control → body triangle → GnP (BJJ purple belt, 1.64 sub/15min, 44% career sub rate, 3 inches of reach edge). But the silent path for Taira is just to OUTLAST — he's 18-1, NEVER knocked out, NEVER submitted, elite chin. If the fight turns into a 25-minute war with Van forcing volume, the close-cards scenario where 1-2 connected takedowns flip the rounds stays live. Probability 32%, real because the sub repertoire exists AND the elite chin keeps a \"split decision for Taira\" outcome on the map.",
      },
      probabilities: { fighter1: { nome: 'Van', percent: 65 }, fighter2: { nome: 'Taira', percent: 32 }, draw: 3 },
      conviction: {
        thesis:
          "The thesis is: Joshua Van wins because, first, he has 8.84 sig strikes per minute (HIGHEST rate in UFC history) at 56.8% accuracy (2nd at flyweight all-time) and 81% elite TDD against Taira's 45% TDD. Second, the common opponent Brandon Royval handed in DIRECT evidence: Royval beat Taira 124-42 in strikes even while absorbing 6 takedowns on 15 attempts and 12:13 of control, and Van beat Royval with 419 combined sig strikes, 30-27 on one card. Third, Van does volume BETTER than Royval (8.84 vs 5.4 SLpM). Path: Van defends the early takedown attempts, opens distance with footwork, stacks volume at his pace through rounds 2-3, and closes with 48-47 or 49-46 cards. Falls apart if Taira gets a back take and locks the body triangle the way he did with Moreno, or simply rides the elite chin for 25 minutes and capitalizes in close rounds.",
        conviction_score: 7,
        conviction_rationale: "Conviction 7 (not 8) because three dimensions converge with direct precedent (Royval), but (1) \"Van's stats\" and \"calibre via Royval\" are partially correlated — that's 1.5 dimensions, not 2; (2) Taira has rare-tier traits the thesis ignores — 19 fights, NEVER knocked out, NEVER submitted, chin and sub defense at a level that keeps close-cards scenarios live; (3) Van's 81% TDD has never been tested against a primary grappler at Taira's level (Royval is grappler-pressure, not grappler-first), and Van has only one 5-round fight (Royval) on record. Market moved Taira -180 → -150 reading the blueprint, but Van as underdog in a title fight still pays real edge. Probabilities 65-32-3 reflect the open floor.",
        conviction_breakers: [
      ...
      value_picks_v2: {
        picks: [
          { type: 'Moneyline', pick: 'Joshua Van', odds: '+150 (FanDuel, Apr 2026)', reasoning: "Real probability estimated at 65%, implied at +150 = 40%. 25-point edge. Market opened Taira -180 and moved to -150 once the sharp money read the Royval blueprint. Confidence is medium because Taira has NEVER been finished in 19 fights and the floor for a split decision in his favor stays live." },
          { type: 'Total Rounds', pick: 'Over 3.5 rounds', odds: '-150 to -200 (estimated)', reasoning: "Van by decision is the primary scenario. Taira has NEVER been knocked out or submitted. Even if Van finishes, late (R4-R5) via accumulation is more likely. The safest pick on the card." },
          { type: 'Method', pick: 'Van by Decision', odds: '+200 to +250 (estimated)', reasoning: "Van went 25 minutes with Royval at full volume. Taira's chin is elite — only finished once in his career (not in the UFC). Most likely scenario is a close UD 48-47 or 49-46. At +225 implied is 31%, edge over a 40% estimate." },
        ],
        best_bet: { pick: 'Total Rounds Over 3.5 at -150 to -200', reasoning: "Safest play on the card. Taira has NEVER been knocked out or submitted in 19 pro fights; Van has NEVER finished anyone before R3. The paths to ending the fight before R4 are limited for both men. Decision is the most likely outcome regardless of who wins — Over 3.5 rounds works either way." },
      },
      key_stats: [
        { value: '0', label: "Times Taira has been knocked out in 19 fights", sublabel: "NEVER knocked out, NEVER submitted. Elite chin and sub defense. Keeps the floor open for Taira regardless of Van's volume." },
