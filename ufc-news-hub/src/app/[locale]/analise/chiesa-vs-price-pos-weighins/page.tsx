...
const analise: FullSingleAnalise = {
  ...
  fighter1_info: {
    ...
    ultimasLutas: [
      ...
      { result: 'L', opponent: 'Kevin Holland', method: 'Decisao Unanime', event: 'UFC 265' },
      { result: 'W', opponent: 'Neil Magny', method: 'Sub R2', event: 'UFC Fight Night' },
    ],
  },
  fighter2_info: {
    nome: 'Niko Price',
    ...
    ranking: 'Sem ranking',
    ultimasLutas: [
      { result: 'L', opponent: 'Nikolay Veretennikov', method: 'KO R1', event: 'UFC Fight Night' },
      { result: 'L', opponent: 'Phil Rowe', method: 'Decisao Unanime', event: 'UFC Fight Night' },
      { result: 'W', opponent: 'Evan Elder', method: 'KO R1', event: 'UFC Fight Night' },
    ],
  },
  ...
  full_analysis: {
      ...
      prognostico: {
        fighter1_vence: {
          ...
          consequencias: [
            ...
            { tag: 'LEGADO', texto: 'Encerra com 19-7 e narrativa de dedicacao total.' },
          ],
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: 'Dez 2024', opponent: 'Kevin Holland', result: 'L', method: 'Sub R1', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Submetido rapidamente.' },
          { date: 'Ago 2023', opponent: 'Kevin Holland', result: 'L', method: 'Decisao Unanime', opponent_rank: '#12 WW', quality_score: 3, quality_label: 'Bom', note: 'Perdeu nos pontos.' },
          { date: 'Mar 2023', opponent: 'Neil Magny', result: 'W', method: 'Sub R2', opponent_rank: '#15 WW', quality_score: 2, quality_label: 'Medio', note: 'Grappling dominante. Submissao textbook.' },
        ],
        momentum_score: 3,
        momentum_label: 'Em Declinio',
        momentum_trend: 'descending',
        momentum_note: 'Duas derrotas seguidas contra Holland. Grappling funciona contra inferiores (Magny). Aos 37, aposentadoria faz sentido. Contra Price (40, pos-KO), Chiesa e claramente o mais saudavel e preparado.',
      },
      fighter2: {
        nome: 'Niko Price',
        color: 'blue',
        recent_fights: [
          { date: 'Fev 2026', opponent: 'Nikolay Veretennikov', result: 'L', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Nocauteado ha 49 dias. Preocupacao de seguranca.' },
          { date: 'Out 2025', opponent: 'Phil Rowe', result: 'L', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Perdeu pra oponente sem ranking.' },
          { date: 'Jun 2025', opponent: 'Evan Elder', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Nocaute rapido. Flashes do velho Price.' },
        ],
        momentum_score: 2,
        momentum_label: 'Em Declinio Terminal',
        momentum_trend: 'descending',
        momentum_note: 'KO ha 49 dias. 40 anos. Duas derrotas em tres. Jon Anik questionou publicamente. Anunciou aposentadoria na pesagem. Short-notice (63% loss rate). Combinacao de fatores extremamente desfavoravel.',
      },
    },
