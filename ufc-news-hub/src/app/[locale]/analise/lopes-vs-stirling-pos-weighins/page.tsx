...
const analise: PrelimsAnalise = {
  ...
  fighter1_info: { nome: 'Bruno Lopes', record: '13-2-0', ultimasLutas: [{ result: 'W', opponent: 'Tafon Nchukwi', method: 'Sub R2', event: 'UFC Fight Night' }] },
  fighter2_info: { nome: 'Navajo Stirling', record: '8-0-0', ultimasLutas: [{ result: 'W', opponent: 'Vitor Petrino', method: 'Decisao Unanime', event: 'UFC Fight Night' }] },
  ...
  prelims_analysis: {
    hero: {
      ...
      num_rounds: 3,
      is_titulo: false,
      fighter1: { nome: 'Bruno Lopes', record: '13-2-0', ranking: 'N/R', imagem_url: 'https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-01/2/LOPES_BRUNO_L_01-11.png?itok=0ZAo1l_Y' },
    ...
    comparacao_estatistica: {
      ...
      tale_of_tape: [
        ...
        { label: 'Kickboxing', fighter1: 'Base BJJ. Ambas derrotas por KO (Jacoby R1, Williams R2).', fighter2: '2x King in the Ring. Campeao mundial WKBF. Invicto 8-0.', note: 'Lopes perdeu AMBAS lutas por KO vs kickboxer campeo mundial' },
      ],
    },
    historico_lutas: {
      fighter1: {
        nome: 'Lopes',
        recent_fights: [
          { date: 'Nov 2025', opponent: 'Tafon Nchukwi', result: 'W', method: 'Sub R2', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Finalizacao no segundo round. Jiu-jitsu eficiente quando consegue o TD.' },
          { date: 'Jun 2025', opponent: 'Oumar Sy', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Vitoria por decisao contra oponente fraco.' },
          { date: 'Fev 2025', opponent: 'Dustin Jacoby', result: 'L', method: 'KO R1 (1:50)', opponent_rank: 'N/R', quality_score: 3, quality_label: 'Bom', note: 'NOCAUTEADO EM 1:50 DO R1. Jacoby parou rapido. Chin exposto como fraqueza critica.' },
          { date: 'Set 2024', opponent: 'Raffael Cerqueira', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Nocaute rapido. Mas contra oponente de nivel baixo.' },
          { date: 'Mar 2024', opponent: 'Karl Williams', result: 'L', method: 'KO R2', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'OUTRA derrota por KO. As DUAS unicas derrotas da carreira sao por nocaute. Padrao claro.' },
        ],
      },
      fighter2: {
        nome: 'Stirling',
        recent_fights: [
          { date: 'Jan 2026', opponent: 'Vitor Petrino', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 3, quality_label: 'Bom', note: 'Dominou prospect brasileiro por 3 rounds. Gestao de distancia impecavel.' },
          { date: 'Ago 2025', opponent: 'Brendson Ribeiro', result: 'W', method: 'TKO R2', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'TKO no segundo round. Debut UFC com finish. Unico finish no UFC.' },
          { date: 'Mar 2025', opponent: 'Jamie Bradshaw', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Contender Series. Garantiu contrato com display tecnico.' },
          { date: 'Out 2024', opponent: 'Tyler Manawaroa', result: 'W', method: 'KO R2', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Nocaute limpo. Poder real nas maos.' },
          { date: 'Jun 2024', opponent: 'Phil Barrett', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'KO rapido. Kickboxing de nivel mundial em acao.' },
        ],
      },
    },
    perfil_habilidades: {
      skills: [
        ...
        { label: 'Jiu-Jitsu e Chao', valueA: 72, valueB: 48, labelA: 'Bom', labelB: 'Medio', advantage: 'fighter1', advantage_note: 'Unica vantagem concreta de Lopes. Submeteu Nchukwi no R2. Se conseguir TD (40% conversao vs 78% TDD), pode ser perigoso. MAS chegar la e o desafio.' },
        ...
        { label: 'Durabilidade', valueA: 40, valueB: 72, labelA: 'Medio', labelB: 'Bom', advantage: 'fighter2', advantage_note: 'Lopes foi nocauteado em AMBAS derrotas (Jacoby em 1:50, Williams no R2). Chin comprometido. Stirling nunca foi parado, invicto 8-0.' },
    ...
    previsao_final: {
      ...
      upset_alert: {
        ...
        description: 'Se Lopes conseguir uma queda (40% conversao) e passar a TDD de Stirling (78%), ele e perigoso no chao. Submeteu Nchukwi no R2 e tem 5 finalizacoes. O upset exige TD early e transicao rapida. E improvavel, mas nao impossivel. Lopes por KO a +480 e o longshot absoluto pra quem gosta de unicornios.',
      },
      probabilities: {
      ...
      value_picks: {
        ...
        method: { pick: 'Stirling por Decisao (-140)', reasoning: 'Favoritos -600+ tem apenas 50% finish rate historicamente. Stirling venceu Petrino por decisao. Gestao de distancia e counter striking sugerem controle por pontos sem risco de finish.' },
