...
const analise: FullSingleAnalise = {
  ...
  fighter1_info: {
    ...
    ranking: 'Sem ranking',
    ultimasLutas: [
      { result: 'W', opponent: 'Bruno Oliveira', method: 'KO R1', event: 'UFC Fight Night' },
      { result: 'L', opponent: 'Cesar Almeida', method: 'KO R1', event: 'UFC Fight Night' },
      { result: 'W', opponent: 'Jamie Pickett', method: 'TKO R1', event: 'UFC Fight Night' },
    ],
  },
  fighter2_info: {
    nome: 'Aziz Belgaroui',
    ...
    ranking: 'Sem ranking',
    ultimasLutas: [
      { result: 'W', opponent: 'Cody Brundage', method: 'KO R1', event: 'DWCS' },
      { result: 'W', opponent: 'Mohamed Amine', method: 'TKO R2', event: 'Brave CF' },
      { result: 'W', opponent: 'Tomas Wojcik', method: 'KO R1', event: 'Brave CF' },
    ],
  },
  ...
  full_analysis: {
    ...
    narrativa: {
      ...
      stakes: [
        ...
        { dimensao: 'Stoppage Rate', fighter1: '9 vitorias, TODAS stoppage, 7 no R1', fighter2: '10 de 12 vitorias por stoppage' },
    ...
    momento_atual: {
      fighter1: {
        ...
        color: 'red',
        recent_fights: [
          { date: 'Out 2025', opponent: 'Bruno Oliveira', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'KO R1. Padrao Abdul-Malik.' },
          { date: 'Jun 2025', opponent: 'Cesar Almeida', result: 'L', method: 'KO R1', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Nocauteado. Mostra que quando nao derruba, e vulneravel em pe.' },
          { date: 'Mar 2025', opponent: 'Jamie Pickett', result: 'W', method: 'TKO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'TKO rapido.' },
        ],
        momentum_score: 6,
        momentum_label: 'Em Alta (com ressalva)',
        momentum_trend: 'ascending',
        momentum_note: 'Abdul-Malik vence rapido ou perde rapido. 9 vitorias TODAS por stoppage, mas a derrota pra Almeida (KO R1) mostra vulnerabilidade quando nao consegue impor o wrestling. Contra Belgaroui, a mesma dinamica: se derrubar, domina. Se ficar em pe contra um kickboxer GLORY de 6\'6", e perigoso.',
      },
      fighter2: {
        nome: 'Aziz Belgaroui',
        color: 'blue',
        recent_fights: [
          { date: 'Set 2025', opponent: 'Cody Brundage', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'KO no DWCS pra ganhar contrato UFC. 36 segundos contra Cam Teague antes.' },
          { date: 'Abr 2025', opponent: 'Mohamed Amine', result: 'W', method: 'TKO R2', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Finalizacao no Brave CF.' },
          { date: 'Jan 2025', opponent: 'Tomas Wojcik', result: 'W', method: 'KO R1', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'KO rapido.' },
        ],
        momentum_score: 7,
    ...
    perfil_habilidades: {
      skills: [
        ...
        { label: 'Poder de Nocaute', valueA: 80, valueB: 78, labelA: 'Muito Bom', labelB: 'Muito Bom', advantage: 'even', advantage_note: 'Ambos batem pesado. Abdul-Malik: 7 KO/TKO em 9 vitorias. Belgaroui: 10 de 12 vitorias por stoppage. O poder e similar, mas a entrega e diferente: Abdul-Malik com GnP, Belgaroui com combinacoes em pe.' },
    ...
    caminhos_vitoria: {
      ...
      fighter2: {
        ...
        scenarios: [
          ...
          { name: 'Sprawl and Brawl', probability: 9, method: 'TKO R2-R3', description: 'Belgaroui defende o takedown (dificil com 50% TDD) e castiga Abdul-Malik em pe. Acumulo de dano. Abdul-Malik perdeu por KO R1 pra Almeida quando nao conseguiu derrubar.' },
        ],
      },
    },
