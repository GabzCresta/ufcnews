...
// Scroll to Radar do Apostador section
const radar = page.locator('text="Edges Estatisticos"').first();
if (await radar.count()) {
  await radar.scrollIntoViewIfNeeded();
  await page.evaluate(() => window.scrollBy(0, -100));
  await page.waitForTimeout(400);
  await page.screenshot({ path: '/tmp/radar-fixed.png', fullPage: false });
  console.log('RADAR SHOT OK');
}
await browser.close();
